...
/* Block signals for system '<S49>/CoreSubsys' */
typedef struct {
  real_T angle;                        /* '<S49>/Discrete-Time Integrator' */
  real_T Delay;                        /* '<S49>/Delay' */
  real_T MaxRotationRate;              /* '<S49>/Max Rotation Rate' */
} B_CoreSubsys_ctrl_custom_T;

/* Block states (auto storage) for system '<S49>/CoreSubsys' */
typedef struct {
  real_T DiscreteTimeIntegrator_DSTATE;/* '<S49>/Discrete-Time Integrator' */
  real_T Delay_DSTATE;                 /* '<S49>/Delay' */
  int8_T DiscreteTimeIntegrator_PrevRese;/* '<S49>/Discrete-Time Integrator' */
  uint8_T DiscreteTimeIntegrator_IC_LOADI;/* '<S49>/Discrete-Time Integrator' */
} DW_CoreSubsys_ctrl_custom_T;

/* Block signals for system '<S56>/MATLAB Function2' */
typedef struct {
  real_T Tc_out;                       /* '<S56>/MATLAB Function2' */
} B_MATLABFunction2_ctrl_custom_T;

/* Block signals for system '<S74>/Core controller: Torque,Power and Combined Torque//Power' */
typedef struct {
  real_T Qcq;                          /* '<S74>/Core controller: Torque,Power and Combined Torque//Power' */
  real_T Qcp;                          /* '<S74>/Core controller: Torque,Power and Combined Torque//Power' */
  real_T Qcc;                          /* '<S74>/Core controller: Torque,Power and Combined Torque//Power' */
} B_CorecontrollerTorquePoweran_T;

/* Block signals for system '<S72>/Supervisor' */
typedef struct {
  real_T u;                            /* '<S72>/Supervisor' */
} B_Supervisor_ctrl_custom_T;

/* Block signals for system '<S79>/Actual Force and Torque' */
typedef struct {
  real_T Ta;                           /* '<S79>/Actual Force and Torque' */
  real_T Qa;                           /* '<S79>/Actual Force and Torque' */
} B_ActualForceandTorque_ctrl_c_T;

/* Block signals for system '<S81>/MATLAB Function' */
typedef struct {
  real_T n_d;                          /* '<S81>/MATLAB Function' */
  real_T T_r;                          /* '<S81>/MATLAB Function' */
...
typedef struct {
  ...
  real_T rpm1;                         /* '<S56>/rpm1 ' */
  real_T rpm2;                         /* '<S56>/rpm2' */
  real_T rpm3;                         /* '<S56>/rpm3' */
  real_T rpm4;                         /* '<S56>/rpm4' */
  real_T rpm5;                         /* '<S56>/rpm5' */
  real_T rpm6;                         /* '<S56>/rpm6' */
  ...
  real_T Saturation1;                  /* '<S55>/Saturation 1' */
  real_T Saturation2;                  /* '<S55>/Saturation 2' */
  real_T Saturation3;                  /* '<S55>/Saturation 3' */
  real_T Saturation4;                  /* '<S55>/Saturation 4' */
  real_T Saturation5;                  /* '<S55>/Saturation 5' */
  real_T Saturation6;                  /* '<S55>/Saturation 6' */
  ...
  real_T Ts_x;                         /* '<S22>/Ts_x' */
  real_T Ts_y;                         /* '<S22>/Ts_y' */
  real_T Sum_a[2];                     /* '<S13>/Sum' */
  real_T Delay[6];                     /* '<S16>/Delay' */
  real_T Delay_d;                      /* '<S57>/Delay' */
  real_T Delay_j;                      /* '<S72>/Delay' */
  real_T DiscreteTransferFcn;          /* '<S72>/Discrete Transfer Fcn' */
  real_T TSamp;                        /* '<S75>/TSamp' */
  real_T Inertiacompensation;          /* '<S72>/Inertia compensation' */
  real_T Sum1_b;                       /* '<S72>/Sum1' */
  real_T Memory;                       /* '<S72>/Memory' */
  real_T Kp;                           /* '<S74>/Kp' */
  real_T reset;                        /* '<S74>/reset' */
  real_T Sum_h;                        /* '<S72>/Sum' */
  real_T DiscreteTransferFcn_b;        /* '<S57>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed;         /* '<S71>/Finding rotation speed' */
  real_T Ki;                           /* '<S74>/Ki' */
  real_T Delay_c;                      /* '<S58>/Delay' */
  real_T Delay_b;                      /* '<S81>/Delay' */
  real_T DiscreteTransferFcn_l;        /* '<S81>/Discrete Transfer Fcn' */
  real_T TSamp_m;                      /* '<S84>/TSamp' */
  real_T Inertiacompensation_b;        /* '<S81>/Inertia compensation' */
  real_T Sum1_l;                       /* '<S81>/Sum1' */
  real_T Memory_l;                     /* '<S81>/Memory' */
  real_T Kp_c;                         /* '<S83>/Kp' */
  real_T reset_l;                      /* '<S83>/reset' */
  real_T Sum_d;                        /* '<S81>/Sum' */
  real_T DiscreteTransferFcn_c;        /* '<S58>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_h;       /* '<S80>/Finding rotation speed' */
  real_T Ki_c;                         /* '<S83>/Ki' */
  real_T Delay_h;                      /* '<S59>/Delay' */
  real_T Delay_i;                      /* '<S90>/Delay' */
  real_T DiscreteTransferFcn_d;        /* '<S90>/Discrete Transfer Fcn' */
  real_T TSamp_k;                      /* '<S93>/TSamp' */
  real_T Inertiacompensation_m;        /* '<S90>/Inertia compensation' */
  real_T Sum1_c;                       /* '<S90>/Sum1' */
  real_T Memory_ln;                    /* '<S90>/Memory' */
  real_T Kp_i;                         /* '<S92>/Kp' */
  real_T reset_i;                      /* '<S92>/reset' */
  real_T Sum_n;                        /* '<S90>/Sum' */
  real_T DiscreteTransferFcn_o;        /* '<S59>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_m;       /* '<S89>/Finding rotation speed' */
  real_T Ki_o;                         /* '<S92>/Ki' */
  real_T Delay_e;                      /* '<S60>/Delay' */
  real_T Delay_m;                      /* '<S99>/Delay' */
  real_T DiscreteTransferFcn_p;        /* '<S99>/Discrete Transfer Fcn' */
  real_T TSamp_d;                      /* '<S102>/TSamp' */
  real_T Inertiacompensation_bn;       /* '<S99>/Inertia compensation' */
  real_T Sum1_cp;                      /* '<S99>/Sum1' */
  real_T Memory_j;                     /* '<S99>/Memory' */
  real_T Kp_o;                         /* '<S101>/Kp' */
  real_T reset_h;                      /* '<S101>/reset' */
  real_T Sum_av;                       /* '<S99>/Sum' */
  real_T DiscreteTransferFcn_oy;       /* '<S60>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_p;       /* '<S98>/Finding rotation speed' */
  real_T Ki_g;                         /* '<S101>/Ki' */
  real_T Delay_jj;                     /* '<S61>/Delay' */
  real_T Delay_n;                      /* '<S108>/Delay' */
  real_T DiscreteTransferFcn_br;       /* '<S108>/Discrete Transfer Fcn' */
  real_T TSamp_k4;                     /* '<S111>/TSamp' */
  real_T Inertiacompensation_a;        /* '<S108>/Inertia compensation' */
  real_T Sum1_e;                       /* '<S108>/Sum1' */
  real_T Memory_d;                     /* '<S108>/Memory' */
  real_T Kp_d;                         /* '<S110>/Kp' */
  real_T reset_e;                      /* '<S110>/reset' */
  real_T Sum_f;                        /* '<S108>/Sum' */
  real_T DiscreteTransferFcn_m;        /* '<S61>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_j;       /* '<S107>/Finding rotation speed' */
  real_T Ki_m;                         /* '<S110>/Ki' */
  real_T Delay_mu;                     /* '<S62>/Delay' */
  real_T Delay_e5;                     /* '<S117>/Delay' */
  real_T DiscreteTransferFcn_lk;       /* '<S117>/Discrete Transfer Fcn' */
  real_T TSamp_mr;                     /* '<S120>/TSamp' */
  real_T Inertiacompensation_b3;       /* '<S117>/Inertia compensation' */
  real_T Sum1_p;                       /* '<S117>/Sum1' */
  real_T Memory_o;                     /* '<S117>/Memory' */
  real_T Kp_k;                         /* '<S119>/Kp' */
  real_T reset_iu;                     /* '<S119>/reset' */
  real_T Sum_g;                        /* '<S117>/Sum' */
  real_T DiscreteTransferFcn_f;        /* '<S62>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_c;       /* '<S116>/Finding rotation speed' */
  real_T Ki_l;                         /* '<S119>/Ki' */
  ...
  real_T n_d;                          /* '<S117>/MATLAB Function' */
  real_T n_d_m;                        /* '<S90>/MATLAB Function' */
  real_T n_d_k;                        /* '<S72>/MATLAB Function' */
  real_T Qa;                           /* '<S70>/Actual Force and Torque' */
  real_T Pa;                           /* '<S70>/Actual Force and Torque' */
  real_T Tc_out;                       /* '<S56>/MATLAB Function1' */
  real_T output[12];                   /* '<S56>/MATLAB Function' */
  real_T commanded_tau[3];             /* '<Root>/MATLAB Function' */
  B_Supervisor_ctrl_custom_T sf_Supervisor_gj;/* '<S117>/Supervisor' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_g;/* '<S119>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_c;/* '<S115>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_T sf_Supervisor_p;/* '<S108>/Supervisor' */
  B_MATLABFunction_ctrl_custo_a_T sf_MATLABFunction_o;/* '<S108>/MATLAB Function' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_o;/* '<S110>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_k;/* '<S106>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_T sf_Supervisor_g;/* '<S99>/Supervisor' */
  B_MATLABFunction_ctrl_custo_a_T sf_MATLABFunction_d;/* '<S99>/MATLAB Function' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_p;/* '<S101>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_a;/* '<S97>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_T sf_Supervisor_j;/* '<S90>/Supervisor' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePower_ao;/* '<S92>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_f;/* '<S88>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_T sf_Supervisor_c;/* '<S81>/Supervisor' */
  B_MATLABFunction_ctrl_custo_a_T sf_MATLABFunction_a;/* '<S81>/MATLAB Function' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_a;/* '<S83>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_m;/* '<S79>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_T sf_Supervisor;/* '<S72>/Supervisor' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowerand;/* '<S74>/Core controller: Torque,Power and Combined Torque//Power' */
  B_MATLABFunction2_ctrl_custom_T sf_MATLABFunction6;/* '<S56>/MATLAB Function6' */
  B_MATLABFunction2_ctrl_custom_T sf_MATLABFunction5;/* '<S56>/MATLAB Function5' */
  B_MATLABFunction2_ctrl_custom_T sf_MATLABFunction4;/* '<S56>/MATLAB Function4' */
  B_MATLABFunction2_ctrl_custom_T sf_MATLABFunction3;/* '<S56>/MATLAB Function3' */
  B_MATLABFunction2_ctrl_custom_T sf_MATLABFunction2;/* '<S56>/MATLAB Function2' */
  B_CoreSubsys_ctrl_custom_T CoreSubsys[6];/* '<S49>/CoreSubsys' */
...
typedef struct {
  ...
  real_T Delay_DSTATE_f;               /* '<S57>/Delay' */
  real_T Delay_DSTATE_k;               /* '<S72>/Delay' */
  real_T DiscreteTransferFcn_states[2];/* '<S72>/Discrete Transfer Fcn' */
  real_T UD_DSTATE;                    /* '<S75>/UD' */
  real_T DiscreteTransferFcn_states_k; /* '<S57>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_c;               /* '<S58>/Delay' */
  real_T Delay_DSTATE_j;               /* '<S81>/Delay' */
  real_T DiscreteTransferFcn_states_j[2];/* '<S81>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_f;                  /* '<S84>/UD' */
  real_T DiscreteTransferFcn_states_j0;/* '<S58>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_m;               /* '<S59>/Delay' */
  real_T Delay_DSTATE_e;               /* '<S90>/Delay' */
  real_T DiscreteTransferFcn_states_f[2];/* '<S90>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_p;                  /* '<S93>/UD' */
  real_T DiscreteTransferFcn_states_m; /* '<S59>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_kg;              /* '<S60>/Delay' */
  real_T Delay_DSTATE_ki;              /* '<S99>/Delay' */
  real_T DiscreteTransferFcn_states_e[2];/* '<S99>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_a;                  /* '<S102>/UD' */
  real_T DiscreteTransferFcn_states_p; /* '<S60>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_p;               /* '<S61>/Delay' */
  real_T Delay_DSTATE_kf;              /* '<S108>/Delay' */
  real_T DiscreteTransferFcn_states_jn[2];/* '<S108>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_l;                  /* '<S111>/UD' */
  real_T DiscreteTransferFcn_states_g; /* '<S61>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_o;               /* '<S62>/Delay' */
  real_T Delay_DSTATE_h;               /* '<S117>/Delay' */
  real_T DiscreteTransferFcn_states_k0[2];/* '<S117>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_e;                  /* '<S120>/UD' */
  real_T DiscreteTransferFcn_states_pv;/* '<S62>/Discrete Transfer Fcn' */
  ...
  real_T rpm1_DWORK1;                  /* '<S56>/rpm1 ' */
  real_T rpm2_DWORK1;                  /* '<S56>/rpm2' */
  real_T rpm3_DWORK1;                  /* '<S56>/rpm3' */
  real_T rpm4_DWORK1;                  /* '<S56>/rpm4' */
  real_T rpm5_DWORK1;                  /* '<S56>/rpm5' */
  real_T rpm6_DWORK1;                  /* '<S56>/rpm6' */
  ...
  real_T x_hat_DWORK1_o;               /* '<S36>/x_hat' */
  real_T y_hat_DWORK1_d;               /* '<S36>/y_hat' */
  real_T psi_hat_DWORK1_g;             /* '<S36>/psi_hat' */
  real_T u_hat_DWORK1;                 /* '<S38>/u_hat' */
  real_T v_hat_DWORK1;                 /* '<S38>/v_hat' */
  real_T r_hat_DWORK1;                 /* '<S38>/r_hat' */
  real_T u_dot_hat_DWORK1;             /* '<S37>/u_dot_hat' */
  real_T v_dot_hat_DWORK1;             /* '<S37>/v_dot_hat' */
  real_T r_dot_hat_DWORK1;             /* '<S37>/r_dot_hat' */
  real_T b_x_hat_DWORK1;               /* '<S35>/b_x_hat' */
  real_T b_y_hat_DWORK1;               /* '<S35>/b_y_hat' */
  real_T b_psi_hat_DWORK1;             /* '<S35>/b_psi_hat' */
  ...
  real_T Ts_x_DWORK1;                  /* '<S22>/Ts_x' */
  real_T Ts_y_DWORK1;                  /* '<S22>/Ts_y' */
  real_T DiscreteTransferFcn_tmp;      /* '<S72>/Discrete Transfer Fcn' */
  real_T PrevY;                        /* '<S72>/Acceleration Limit' */
  real_T Memory_PreviousInput;         /* '<S72>/Memory' */
  real_T reset_DWORK1;                 /* '<S74>/reset' */
  real_T DiscreteTransferFcn_tmp_n;    /* '<S57>/Discrete Transfer Fcn' */
  real_T Control_test_Pa_DWORK1;       /* '<S70>/Control_test_Pa' */
  real_T DiscreteTransferFcn_tmp_f;    /* '<S81>/Discrete Transfer Fcn' */
  real_T PrevY_p;                      /* '<S81>/Acceleration Limit' */
  real_T Memory_PreviousInput_g;       /* '<S81>/Memory' */
  real_T reset_DWORK1_d;               /* '<S83>/reset' */
  real_T DiscreteTransferFcn_tmp_fg;   /* '<S58>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_k;    /* '<S90>/Discrete Transfer Fcn' */
  real_T PrevY_k;                      /* '<S90>/Acceleration limiter' */
  real_T Memory_PreviousInput_f;       /* '<S90>/Memory' */
  real_T reset_DWORK1_o;               /* '<S92>/reset' */
  real_T DiscreteTransferFcn_tmp_b;    /* '<S59>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_l;    /* '<S99>/Discrete Transfer Fcn' */
  real_T PrevY_m;                      /* '<S99>/Acceleration limiter' */
  real_T Memory_PreviousInput_d;       /* '<S99>/Memory' */
  real_T reset_DWORK1_l;               /* '<S101>/reset' */
  real_T DiscreteTransferFcn_tmp_fg5;  /* '<S60>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_i;    /* '<S108>/Discrete Transfer Fcn' */
  real_T PrevY_mo;                     /* '<S108>/Acceleration limiter' */
  real_T Memory_PreviousInput_l;       /* '<S108>/Memory' */
  real_T reset_DWORK1_dp;              /* '<S110>/reset' */
  real_T DiscreteTransferFcn_tmp_m;    /* '<S61>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_o;    /* '<S117>/Discrete Transfer Fcn' */
  real_T PrevY_k4;                     /* '<S117>/Acceleration limiter' */
  real_T Memory_PreviousInput_f2;      /* '<S117>/Memory' */
  real_T reset_DWORK1_dy;              /* '<S119>/reset' */
  real_T DiscreteTransferFcn_tmp_ir;   /* '<S62>/Discrete Transfer Fcn' */
  ...
  uint8_T K_p_x_DWORK2[12];            /* '<S19>/K_p_x' */
  uint8_T K_p_y_DWORK2[12];            /* '<S19>/K_p_y' */
  uint8_T K_p_psi_DWORK2[12];          /* '<S19>/K_p_psi' */
  uint8_T K_i_psi_DWORK2[12];          /* '<S19>/K_i_psi' */
  uint8_T K_i_x_DWORK2[12];            /* '<S19>/K_i_x' */
  uint8_T K_i_y_DWORK2[12];            /* '<S19>/K_i_y' */
  uint8_T K_d_psi_DWORK2[12];          /* '<S19>/K_d_psi' */
  uint8_T K_d_x_DWORK2[12];            /* '<S19>/K_d_x' */
  uint8_T K_d_y_DWORK2[12];            /* '<S19>/K_d_y' */
  ...
  uint8_T rpm1_DWORK2[12];             /* '<S56>/rpm1 ' */
  uint8_T rpm2_DWORK2[12];             /* '<S56>/rpm2' */
  uint8_T rpm3_DWORK2[12];             /* '<S56>/rpm3' */
  uint8_T rpm4_DWORK2[12];             /* '<S56>/rpm4' */
  uint8_T rpm5_DWORK2[12];             /* '<S56>/rpm5' */
  uint8_T rpm6_DWORK2[12];             /* '<S56>/rpm6' */
  uint8_T thr_angle_1_DWORK2[12];      /* '<S17>/thr_angle_1' */
  uint8_T thr_angle_2_DWORK2[12];      /* '<S17>/thr_angle_2' */
  uint8_T thr_angle_3_DWORK2[12];      /* '<S17>/thr_angle_3' */
  uint8_T thr_angle_4_DWORK2[12];      /* '<S17>/thr_angle_4' */
  uint8_T thr_angle_5_DWORK2[12];      /* '<S17>/thr_angle_5' */
  uint8_T thr_angle_6_DWORK2[12];      /* '<S17>/thr_angle_6' */
  uint8_T Angle_controller_DWORK2[12]; /* '<S14>/Angle_controller' */
  uint8_T tau_commanded_psi_DWORK2[12];/* '<Root>/tau_commanded_psi' */
  uint8_T tau_commanded_x_DWORK2[12];  /* '<Root>/tau_commanded_x' */
  uint8_T x_hat_DWORK2_b[12];          /* '<S36>/x_hat' */
  uint8_T y_hat_DWORK2_l[12];          /* '<S36>/y_hat' */
  uint8_T psi_hat_DWORK2_k[12];        /* '<S36>/psi_hat' */
  uint8_T u_hat_DWORK2[12];            /* '<S38>/u_hat' */
  uint8_T v_hat_DWORK2[12];            /* '<S38>/v_hat' */
  uint8_T r_hat_DWORK2[12];            /* '<S38>/r_hat' */
  uint8_T u_dot_hat_DWORK2[12];        /* '<S37>/u_dot_hat' */
  uint8_T v_dot_hat_DWORK2[12];        /* '<S37>/v_dot_hat' */
  uint8_T r_dot_hat_DWORK2[12];        /* '<S37>/r_dot_hat' */
  uint8_T b_x_hat_DWORK2[12];          /* '<S35>/b_x_hat' */
  uint8_T b_y_hat_DWORK2[12];          /* '<S35>/b_y_hat' */
  uint8_T b_psi_hat_DWORK2[12];        /* '<S35>/b_psi_hat' */
  uint8_T alpha1_DWORK2[12];           /* '<S18>/alpha1' */
  uint8_T alpha2_DWORK2[12];           /* '<S18>/alpha2' */
  uint8_T alpha3_DWORK2[12];           /* '<S18>/alpha3' */
  uint8_T alpha4_DWORK2[12];           /* '<S18>/alpha4' */
  uint8_T alpha5_DWORK2[12];           /* '<S18>/alpha5' */
  uint8_T alpha6_DWORK2[12];           /* '<S18>/alpha6' */
  uint8_T u1_DWORK2[12];               /* '<S18>/u1' */
  uint8_T u2_DWORK2[12];               /* '<S18>/u2' */
  uint8_T u3_DWORK2[12];               /* '<S18>/u3' */
  uint8_T u4_DWORK2[12];               /* '<S18>/u4' */
  uint8_T u5_DWORK2[12];               /* '<S18>/u5' */
  uint8_T u6_DWORK2[12];               /* '<S18>/u6' */
  ...
  uint8_T w_x_DWORK2[12];              /* '<S20>/w_x' */
  uint8_T w_y_DWORK2[12];              /* '<S20>/w_y' */
  uint8_T w_psi_DWORK2[12];            /* '<S20>/w_psi' */
  uint8_T zeta_psi_DWORK2[12];         /* '<S20>/zeta_psi' */
  uint8_T zeta_x_DWORK2[12];           /* '<S20>/zeta_x' */
  uint8_T zeta_y_DWORK2[12];           /* '<S20>/zeta_y' */
  uint8_T T_psi_DWORK2[12];            /* '<S20>/T_psi' */
  uint8_T T_x_DWORK2[12];              /* '<S20>/T_x' */
  uint8_T T_y_DWORK2[12];              /* '<S20>/T_y' */
  uint8_T Ts_x_DWORK2[12];             /* '<S22>/Ts_x' */
  uint8_T Ts_y_DWORK2[12];             /* '<S22>/Ts_y' */
  uint8_T reset_DWORK2[12];            /* '<S74>/reset' */
  uint8_T Control_test_Pa_DWORK2[12];  /* '<S70>/Control_test_Pa' */
  uint8_T reset_DWORK2_k[12];          /* '<S83>/reset' */
  uint8_T reset_DWORK2_p[12];          /* '<S92>/reset' */
  uint8_T reset_DWORK2_m[12];          /* '<S101>/reset' */
  uint8_T reset_DWORK2_i[12];          /* '<S110>/reset' */
  uint8_T reset_DWORK2_j[12];          /* '<S119>/reset' */
  ...
  DW_CoreSubsys_ctrl_custom_T CoreSubsys[6];/* '<S49>/CoreSubsys' */
} DW_ctrl_custom_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_a;          /* '<S71>/Integrator' */
  real_T Integrator_CSTATE_f;          /* '<S80>/Integrator' */
  real_T Integrator_CSTATE_ao;         /* '<S89>/Integrator' */
  real_T Integrator_CSTATE_k;          /* '<S98>/Integrator' */
  real_T Integrator_CSTATE_k2;         /* '<S107>/Integrator' */
  real_T Integrator_CSTATE_i;          /* '<S116>/Integrator' */
  ...
  real_T Integrator_CSTATE_m;          /* '<S74>/Integrator' */
  real_T Integrator_CSTATE_ko;         /* '<S83>/Integrator' */
  real_T Integrator_CSTATE_c;          /* '<S92>/Integrator' */
  real_T Integrator_CSTATE_p;          /* '<S101>/Integrator' */
  real_T Integrator_CSTATE_n;          /* '<S110>/Integrator' */
  real_T Integrator_CSTATE_ci;         /* '<S119>/Integrator' */
} X_ctrl_custom_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_a;       /* '<S71>/Integrator' */
  boolean_T Integrator_CSTATE_f;       /* '<S80>/Integrator' */
  boolean_T Integrator_CSTATE_ao;      /* '<S89>/Integrator' */
  boolean_T Integrator_CSTATE_k;       /* '<S98>/Integrator' */
  boolean_T Integrator_CSTATE_k2;      /* '<S107>/Integrator' */
  boolean_T Integrator_CSTATE_i;       /* '<S116>/Integrator' */
  ...
  boolean_T Integrator_CSTATE_m;       /* '<S74>/Integrator' */
  boolean_T Integrator_CSTATE_ko;      /* '<S83>/Integrator' */
  boolean_T Integrator_CSTATE_c;       /* '<S92>/Integrator' */
  boolean_T Integrator_CSTATE_p;       /* '<S101>/Integrator' */
  boolean_T Integrator_CSTATE_n;       /* '<S110>/Integrator' */
  boolean_T Integrator_CSTATE_ci;      /* '<S119>/Integrator' */
} XDis_ctrl_custom_T;
...
typedef struct {
  ...
  ZCSigState Integrator_Reset_ZCE_g;   /* '<S71>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_n;   /* '<S80>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_e;   /* '<S89>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_l;   /* '<S98>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_j;   /* '<S107>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_m;   /* '<S116>/Integrator' */
  ZCSigState Integrator2_Reset_ZCE;    /* '<S5>/Integrator2' */
  ZCSigState Integrator_Reset_ZCE_lk;  /* '<S74>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_p;   /* '<S83>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_gm;  /* '<S92>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_ja;  /* '<S101>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_i;   /* '<S110>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_b;   /* '<S119>/Integrator' */
...
/* Parameters for system: '<S49>/CoreSubsys' */
...
struct P_ctrl_custom_T_ {
  ...
  real_T Max_rotation;                 /* Variable: Max_rotation
                                        * Referenced by: '<S49>/Max Rotation Rate'
                                        */
  ...
  real_T Saturation1_LowerSat_p;       /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 1'
                                        */
  real_T Saturation2_UpperSat_j;       /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 2'
                                        */
  ...
  real_T Saturation8_LowerSat;         /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 8'
                                        */
  real_T Saturation9_UpperSat;         /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 9'
                                        */
  ...
  real_T Saturation10_LowerSat;        /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 10'
                                        */
  real_T Saturation11_UpperSat;        /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 11'
                                        */
  ...
  real_T Saturation3_LowerSat_m;       /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 3'
                                        */
  real_T Saturation4_UpperSat_l;       /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 4'
                                        */
  ...
  real_T Saturation5_LowerSat_j;       /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 5'
                                        */
  real_T Saturation6_UpperSat_c;       /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 6'
                                        */
  ...
  real_T Saturation12_LowerSat;        /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 12'
                                        */
  real_T Saturation13_UpperSat;        /* Expression: 0
                                        * Referenced by: '<S56>/Saturation 13'
                                        */
  ...
  real_T Control_test_Pa_P1;           /* Expression: width
                                        * Referenced by: '<S70>/Control_test_Pa'
                                        */
  ...
  real_T AccelerationLimit_RisingLim_p;/* Computed Parameter: AccelerationLimit_RisingLim_p
                                        * Referenced by: '<S81>/Acceleration Limit'
                                        */
  ...
  real_T DiscreteTransferFcn_InitialSt_j;/* Expression: 0
                                          * Referenced by: '<S62>/Discrete Transfer Fcn'
                                          */
  ...
  uint32_T Delay_DelayLength_hw;       /* Computed Parameter: Delay_DelayLength_hw
                                        * Referenced by: '<S117>/Delay'
                                        */
  P_CoreSubsys_ctrl_custom_T CoreSubsys;/* '<S49>/CoreSubsys' */
};
 ...
 * '<S13>'  : 'ctrl_custom/SP Generator'
 * '<S14>'  : 'ctrl_custom/Thrust allocation'
 * '<S15>'  : 'ctrl_custom/Thruster Parameters '
 * '<S16>'  : 'ctrl_custom/Thruster control '
 * '<S17>'  : 'ctrl_custom/Thruster measurment'
 * '<S18>'  : 'ctrl_custom/gain'
 * '<S19>'  : 'ctrl_custom/Initialization of parameters/Control Gains'
 * '<S20>'  : 'ctrl_custom/Initialization of parameters/Guidance Gains'
 * '<S21>'  : 'ctrl_custom/Initialization of parameters/Observer Gains'
 * '<S22>'  : 'ctrl_custom/Initialization of parameters/Setpoint Chasing'
 * '<S23>'  : 'ctrl_custom/Initialization of parameters/Guidance Gains/MATLAB Function'
 * '<S24>'  : 'ctrl_custom/Initialization of parameters/Guidance Gains/MATLAB Function1'
 * '<S25>'  : 'ctrl_custom/Initialization of parameters/Guidance Gains/MATLAB Function2'
 * '<S26>'  : 'ctrl_custom/Initialization of parameters/Setpoint Chasing/MATLAB Function'
 * '<S27>'  : 'ctrl_custom/Initialization of parameters/Setpoint Chasing/MATLAB Function1'
 * '<S28>'  : 'ctrl_custom/Nonlinear Passisve Observer/C(nu)*nu'
 * '<S29>'  : 'ctrl_custom/Nonlinear Passisve Observer/D(nu)*nu'
 * '<S30>'  : 'ctrl_custom/Nonlinear Passisve Observer/Rotation matrix in yaw 1'
 * '<S31>'  : 'ctrl_custom/Nonlinear Passisve Observer/Transpose Rotation Matrix'
 * '<S32>'  : 'ctrl_custom/Nonlinear Passisve Observer/Transpose Rotation matrix'
 * '<S33>'  : 'ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]'
 * '<S34>'  : 'ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]1'
 * '<S35>'  : 'ctrl_custom/Observer output /b_hat output'
 * '<S36>'  : 'ctrl_custom/Observer output /eta_hat output'
 * '<S37>'  : 'ctrl_custom/Observer output /nu_dot_hat output'
 * '<S38>'  : 'ctrl_custom/Observer output /nu_hat output'
 * '<S39>'  : 'ctrl_custom/PID controller/Transposed rotation  matrix in yaw1'
 * '<S40>'  : 'ctrl_custom/PID controller/Transposed rotation  matrix in yaw2'
 * '<S41>'  : 'ctrl_custom/PID controller/[-inf inf] to [-pi pi]'
 * '<S42>'  : 'ctrl_custom/PID controller/[-inf inf] to [-pi pi]1'
 * '<S43>'  : 'ctrl_custom/PID controller1/[-inf inf] to [-pi pi]'
 * '<S44>'  : 'ctrl_custom/Referance/MATLAB Function'
 * '<S45>'  : 'ctrl_custom/Referance/MATLAB Function1'
 * '<S46>'  : 'ctrl_custom/Referance/MATLAB Function2'
 * '<S47>'  : 'ctrl_custom/Referance/[-inf inf] to [-pi pi]'
 * '<S48>'  : 'ctrl_custom/Thrust allocation/MATLAB Function'
 * '<S49>'  : 'ctrl_custom/Thrust allocation/Optimal angle path and  constraints on rotation speed'
 * '<S50>'  : 'ctrl_custom/Thrust allocation/Radians to Degrees'
 * '<S51>'  : 'ctrl_custom/Thrust allocation/angle between  [-180 180]'
 * '<S52>'  : 'ctrl_custom/Thrust allocation/Optimal angle path and  constraints on rotation speed/Degrees to Radians'
 * '<S53>'  : 'ctrl_custom/Thrust allocation/Optimal angle path and  constraints on rotation speed/Ensuring angle is  [-pi pi]'
 * '<S54>'  : 'ctrl_custom/Thrust allocation/Optimal angle path and  constraints on rotation speed/MATLAB Function1'
 * '<S55>'  : 'ctrl_custom/Thruster control /Subsystem1'
 * '<S56>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM'
 * '<S57>'  : 'ctrl_custom/Thruster control /Thruster 1'
 * '<S58>'  : 'ctrl_custom/Thruster control /Thruster 2'
 * '<S59>'  : 'ctrl_custom/Thruster control /Thruster 3'
 * '<S60>'  : 'ctrl_custom/Thruster control /Thruster 4'
 * '<S61>'  : 'ctrl_custom/Thruster control /Thruster 5'
 * '<S62>'  : 'ctrl_custom/Thruster control /Thruster 6'
 * '<S63>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function'
 * '<S64>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function1'
 * '<S65>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function2'
 * '<S66>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function3'
 * '<S67>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function4'
 * '<S68>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function5'
 * '<S69>'  : 'ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function6'
 * '<S70>'  : 'ctrl_custom/Thruster control /Thruster 1/Propeller Hydrodynamics'
 * '<S71>'  : 'ctrl_custom/Thruster control /Thruster 1/Shaft dynamics'
 * '<S72>'  : 'ctrl_custom/Thruster control /Thruster 1/Thruster control'
 * '<S73>'  : 'ctrl_custom/Thruster control /Thruster 1/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S74>'  : 'ctrl_custom/Thruster control /Thruster 1/Thruster control/Core controller'
 * '<S75>'  : 'ctrl_custom/Thruster control /Thruster 1/Thruster control/Discrete Derivative'
 * '<S76>'  : 'ctrl_custom/Thruster control /Thruster 1/Thruster control/MATLAB Function'
 * '<S77>'  : 'ctrl_custom/Thruster control /Thruster 1/Thruster control/Supervisor'
 * '<S78>'  : 'ctrl_custom/Thruster control /Thruster 1/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S79>'  : 'ctrl_custom/Thruster control /Thruster 2/Propeller Hydrodynamics'
 * '<S80>'  : 'ctrl_custom/Thruster control /Thruster 2/Shaft dynamics'
 * '<S81>'  : 'ctrl_custom/Thruster control /Thruster 2/Thruster control'
 * '<S82>'  : 'ctrl_custom/Thruster control /Thruster 2/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S83>'  : 'ctrl_custom/Thruster control /Thruster 2/Thruster control/Core controller'
 * '<S84>'  : 'ctrl_custom/Thruster control /Thruster 2/Thruster control/Discrete Derivative'
 * '<S85>'  : 'ctrl_custom/Thruster control /Thruster 2/Thruster control/MATLAB Function'
 * '<S86>'  : 'ctrl_custom/Thruster control /Thruster 2/Thruster control/Supervisor'
 * '<S87>'  : 'ctrl_custom/Thruster control /Thruster 2/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S88>'  : 'ctrl_custom/Thruster control /Thruster 3/Propeller Hydrodynamics'
 * '<S89>'  : 'ctrl_custom/Thruster control /Thruster 3/Shaft dynamics'
 * '<S90>'  : 'ctrl_custom/Thruster control /Thruster 3/Thruster control'
 * '<S91>'  : 'ctrl_custom/Thruster control /Thruster 3/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S92>'  : 'ctrl_custom/Thruster control /Thruster 3/Thruster control/Core controller'
 * '<S93>'  : 'ctrl_custom/Thruster control /Thruster 3/Thruster control/Discrete Derivative'
 * '<S94>'  : 'ctrl_custom/Thruster control /Thruster 3/Thruster control/MATLAB Function'
 * '<S95>'  : 'ctrl_custom/Thruster control /Thruster 3/Thruster control/Supervisor'
 * '<S96>'  : 'ctrl_custom/Thruster control /Thruster 3/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S97>'  : 'ctrl_custom/Thruster control /Thruster 4/Propeller Hydrodynamics'
 * '<S98>'  : 'ctrl_custom/Thruster control /Thruster 4/Shaft dynamics'
 * '<S99>'  : 'ctrl_custom/Thruster control /Thruster 4/Thruster control'
 * '<S100>' : 'ctrl_custom/Thruster control /Thruster 4/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S101>' : 'ctrl_custom/Thruster control /Thruster 4/Thruster control/Core controller'
 * '<S102>' : 'ctrl_custom/Thruster control /Thruster 4/Thruster control/Discrete Derivative'
 * '<S103>' : 'ctrl_custom/Thruster control /Thruster 4/Thruster control/MATLAB Function'
 * '<S104>' : 'ctrl_custom/Thruster control /Thruster 4/Thruster control/Supervisor'
 * '<S105>' : 'ctrl_custom/Thruster control /Thruster 4/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S106>' : 'ctrl_custom/Thruster control /Thruster 5/Propeller Hydrodynamics'
 * '<S107>' : 'ctrl_custom/Thruster control /Thruster 5/Shaft dynamics'
 * '<S108>' : 'ctrl_custom/Thruster control /Thruster 5/Thruster control'
 * '<S109>' : 'ctrl_custom/Thruster control /Thruster 5/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S110>' : 'ctrl_custom/Thruster control /Thruster 5/Thruster control/Core controller'
 * '<S111>' : 'ctrl_custom/Thruster control /Thruster 5/Thruster control/Discrete Derivative'
 * '<S112>' : 'ctrl_custom/Thruster control /Thruster 5/Thruster control/MATLAB Function'
 * '<S113>' : 'ctrl_custom/Thruster control /Thruster 5/Thruster control/Supervisor'
 * '<S114>' : 'ctrl_custom/Thruster control /Thruster 5/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S115>' : 'ctrl_custom/Thruster control /Thruster 6/Propeller Hydrodynamics'
 * '<S116>' : 'ctrl_custom/Thruster control /Thruster 6/Shaft dynamics'
 * '<S117>' : 'ctrl_custom/Thruster control /Thruster 6/Thruster control'
 * '<S118>' : 'ctrl_custom/Thruster control /Thruster 6/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S119>' : 'ctrl_custom/Thruster control /Thruster 6/Thruster control/Core controller'
 * '<S120>' : 'ctrl_custom/Thruster control /Thruster 6/Thruster control/Discrete Derivative'
 * '<S121>' : 'ctrl_custom/Thruster control /Thruster 6/Thruster control/MATLAB Function'
 * '<S122>' : 'ctrl_custom/Thruster control /Thruster 6/Thruster control/Supervisor'
 * '<S123>' : 'ctrl_custom/Thruster control /Thruster 6/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 */
