/*
 * ctrl_custom_turning_frame_private.h
 *
...
#ifndef RTW_HEADER_ctrl_custom_turning_frame_private_h_
#define RTW_HEADER_ctrl_custom_turning_frame_private_h_
#include "rtwtypes.h"
...
extern void ctrl_custom_turn_MATLABFunction(const real_T rtu_omega[9], const
  real_T rtu_zeta[9], B_MATLABFunction_ctrl_custom__T *localB);
extern void ctrl_custom_tur_MATLABFunction2(real_T rtu_Tc_in1, real_T rtu_signal,
...
extern void ctrl_custom_turning__Supervisor(real_T rtu_control, real_T rtu_input,
...
extern void ctrl_custom_tu_MATLABFunction_a(real_T rtu_Td, real_T rtu_K_t0,
...
extern void ctrl_custom_turning_frame_derivatives(void);

#endif                                 /* RTW_HEADER_ctrl_custom_turning_frame_private_h_ */
