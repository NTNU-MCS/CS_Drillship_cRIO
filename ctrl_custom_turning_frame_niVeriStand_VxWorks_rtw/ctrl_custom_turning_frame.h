...
#ifndef RTW_HEADER_ctrl_custom_turning_frame_h_
#define RTW_HEADER_ctrl_custom_turning_frame_h_
#include <float.h>
#include <math.h>
#include <string.h>
#include <stddef.h>
#ifndef ctrl_custom_turning_frame_COMMON_INCLUDES_
# define ctrl_custom_turning_frame_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "zero_crossing_types.h"
#include "simstruc.h"
#include "fixedpoint.h"
#include "rt_logging.h"
#endif                                 /* ctrl_custom_turning_frame_COMMON_INCLUDES_ */

#include "ctrl_custom_turning_frame_types.h"
...
#define ctrl_custom_turning_frame_rtModel RT_MODEL_ctrl_custom_turning__T
...
} B_CoreSubsys_ctrl_custom_turn_T;
...
} DW_CoreSubsys_ctrl_custom_tur_T;
...
} B_Supervisor_ctrl_custom_turn_T;
...
typedef struct {
  ...
  real_T T_x;                          /* '<S19>/T_x' */
  real_T T_y;                          /* '<S19>/T_y' */
  real_T psi_ref;                      /* '<S11>/psi_ref' */
  real_T Sum_m[3];                     /* '<S11>/Sum' */
  real_T Sum2[3];                      /* '<S11>/Sum2' */
  real_T Delay[6];                     /* '<S15>/Delay' */
  real_T Delay_d;                      /* '<S53>/Delay' */
  real_T Delay_j;                      /* '<S68>/Delay' */
  ...
  real_T Sum1_b;                       /* '<S68>/Sum1' */
  real_T Memory;                       /* '<S68>/Memory' */
  real_T Kp;                           /* '<S70>/Kp' */
  real_T reset;                        /* '<S70>/reset' */
  real_T Sum_h;                        /* '<S68>/Sum' */
  real_T DiscreteTransferFcn_b;        /* '<S53>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed;         /* '<S67>/Finding rotation speed' */
  real_T Ki;                           /* '<S70>/Ki' */
  real_T Delay_c;                      /* '<S54>/Delay' */
  real_T Delay_b;                      /* '<S77>/Delay' */
  real_T DiscreteTransferFcn_l;        /* '<S77>/Discrete Transfer Fcn' */
  real_T TSamp_m;                      /* '<S80>/TSamp' */
  real_T Inertiacompensation_b;        /* '<S77>/Inertia compensation' */
  real_T Sum1_l;                       /* '<S77>/Sum1' */
  real_T Memory_l;                     /* '<S77>/Memory' */
  real_T Kp_c;                         /* '<S79>/Kp' */
  real_T reset_l;                      /* '<S79>/reset' */
  real_T Sum_d;                        /* '<S77>/Sum' */
  real_T DiscreteTransferFcn_c;        /* '<S54>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_h;       /* '<S76>/Finding rotation speed' */
  real_T Ki_c;                         /* '<S79>/Ki' */
  real_T Delay_h;                      /* '<S55>/Delay' */
  real_T Delay_i;                      /* '<S86>/Delay' */
  real_T DiscreteTransferFcn_d;        /* '<S86>/Discrete Transfer Fcn' */
  real_T TSamp_k;                      /* '<S89>/TSamp' */
  real_T Inertiacompensation_m;        /* '<S86>/Inertia compensation' */
  real_T Sum1_c;                       /* '<S86>/Sum1' */
  real_T Memory_ln;                    /* '<S86>/Memory' */
  real_T Kp_i;                         /* '<S88>/Kp' */
  real_T reset_i;                      /* '<S88>/reset' */
  real_T Sum_n;                        /* '<S86>/Sum' */
  real_T DiscreteTransferFcn_o;        /* '<S55>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_m;       /* '<S85>/Finding rotation speed' */
  real_T Ki_o;                         /* '<S88>/Ki' */
  real_T Delay_e;                      /* '<S56>/Delay' */
  real_T Delay_m;                      /* '<S95>/Delay' */
  real_T DiscreteTransferFcn_p;        /* '<S95>/Discrete Transfer Fcn' */
  real_T TSamp_d;                      /* '<S98>/TSamp' */
  real_T Inertiacompensation_bn;       /* '<S95>/Inertia compensation' */
  real_T Sum1_cp;                      /* '<S95>/Sum1' */
  real_T Memory_j;                     /* '<S95>/Memory' */
  real_T Kp_o;                         /* '<S97>/Kp' */
  real_T reset_h;                      /* '<S97>/reset' */
  real_T Sum_a;                        /* '<S95>/Sum' */
  real_T DiscreteTransferFcn_oy;       /* '<S56>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_p;       /* '<S94>/Finding rotation speed' */
  real_T Ki_g;                         /* '<S97>/Ki' */
  real_T Delay_jj;                     /* '<S57>/Delay' */
  real_T Delay_n;                      /* '<S104>/Delay' */
  real_T DiscreteTransferFcn_br;       /* '<S104>/Discrete Transfer Fcn' */
  real_T TSamp_k4;                     /* '<S107>/TSamp' */
  real_T Inertiacompensation_a;        /* '<S104>/Inertia compensation' */
  real_T Sum1_e;                       /* '<S104>/Sum1' */
  real_T Memory_d;                     /* '<S104>/Memory' */
  real_T Kp_d;                         /* '<S106>/Kp' */
  real_T reset_e;                      /* '<S106>/reset' */
  real_T Sum_f;                        /* '<S104>/Sum' */
  real_T DiscreteTransferFcn_m;        /* '<S57>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_j;       /* '<S103>/Finding rotation speed' */
  real_T Ki_m;                         /* '<S106>/Ki' */
  real_T Delay_mu;                     /* '<S58>/Delay' */
  real_T Delay_e5;                     /* '<S113>/Delay' */
  real_T DiscreteTransferFcn_lk;       /* '<S113>/Discrete Transfer Fcn' */
  real_T TSamp_mr;                     /* '<S116>/TSamp' */
  real_T Inertiacompensation_b3;       /* '<S113>/Inertia compensation' */
  real_T Sum1_p;                       /* '<S113>/Sum1' */
  real_T Memory_o;                     /* '<S113>/Memory' */
  real_T Kp_k;                         /* '<S115>/Kp' */
  real_T reset_iu;                     /* '<S115>/reset' */
  real_T Sum_g;                        /* '<S113>/Sum' */
  real_T DiscreteTransferFcn_f;        /* '<S58>/Discrete Transfer Fcn' */
  real_T Findingrotationspeed_c;       /* '<S112>/Finding rotation speed' */
  real_T Ki_l;                         /* '<S115>/Ki' */
  ...
  real_T n_d_m;                        /* '<S86>/MATLAB Function' */
  real_T n_d_k;                        /* '<S68>/MATLAB Function' */
  ...
  B_Supervisor_ctrl_custom_turn_T sf_Supervisor_gj;/* '<S113>/Supervisor' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_g;/* '<S115>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_c;/* '<S111>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_turn_T sf_Supervisor_p;/* '<S104>/Supervisor' */
  B_MATLABFunction_ctrl_custo_a_T sf_MATLABFunction_o;/* '<S104>/MATLAB Function' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_o;/* '<S106>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_k;/* '<S102>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_turn_T sf_Supervisor_g;/* '<S95>/Supervisor' */
  B_MATLABFunction_ctrl_custo_a_T sf_MATLABFunction_d;/* '<S95>/MATLAB Function' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_p;/* '<S97>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_a;/* '<S93>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_turn_T sf_Supervisor_j;/* '<S86>/Supervisor' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePower_ao;/* '<S88>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_f;/* '<S84>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_turn_T sf_Supervisor_c;/* '<S77>/Supervisor' */
  B_MATLABFunction_ctrl_custo_a_T sf_MATLABFunction_a;/* '<S77>/MATLAB Function' */
  B_CorecontrollerTorquePoweran_T sf_CorecontrollerTorquePowera_a;/* '<S79>/Core controller: Torque,Power and Combined Torque//Power' */
  B_ActualForceandTorque_ctrl_c_T sf_ActualForceandTorque_m;/* '<S75>/Actual Force and Torque' */
  B_Supervisor_ctrl_custom_turn_T sf_Supervisor;/* '<S68>/Supervisor' */
  ...
  B_CoreSubsys_ctrl_custom_turn_T CoreSubsys[6];/* '<S45>/CoreSubsys' */
...
} B_ctrl_custom_turning_frame_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T Delay_DSTATE[6];              /* '<S15>/Delay' */
  real_T Delay_DSTATE_f;               /* '<S53>/Delay' */
  real_T Delay_DSTATE_k;               /* '<S68>/Delay' */
  ...
  real_T Delay_DSTATE_c;               /* '<S54>/Delay' */
  real_T Delay_DSTATE_j;               /* '<S77>/Delay' */
  real_T DiscreteTransferFcn_states_j[2];/* '<S77>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_f;                  /* '<S80>/UD' */
  real_T DiscreteTransferFcn_states_j0;/* '<S54>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_m;               /* '<S55>/Delay' */
  real_T Delay_DSTATE_e;               /* '<S86>/Delay' */
  real_T DiscreteTransferFcn_states_f[2];/* '<S86>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_p;                  /* '<S89>/UD' */
  real_T DiscreteTransferFcn_states_m; /* '<S55>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_kg;              /* '<S56>/Delay' */
  real_T Delay_DSTATE_ki;              /* '<S95>/Delay' */
  real_T DiscreteTransferFcn_states_e[2];/* '<S95>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_a;                  /* '<S98>/UD' */
  real_T DiscreteTransferFcn_states_p; /* '<S56>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_p;               /* '<S57>/Delay' */
  real_T Delay_DSTATE_kf;              /* '<S104>/Delay' */
  real_T DiscreteTransferFcn_states_jn[2];/* '<S104>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_l;                  /* '<S107>/UD' */
  real_T DiscreteTransferFcn_states_g; /* '<S57>/Discrete Transfer Fcn' */
  real_T Delay_DSTATE_o;               /* '<S58>/Delay' */
  real_T Delay_DSTATE_h;               /* '<S113>/Delay' */
  real_T DiscreteTransferFcn_states_k0[2];/* '<S113>/Discrete Transfer Fcn' */
  real_T UD_DSTATE_e;                  /* '<S116>/UD' */
  real_T DiscreteTransferFcn_states_pv;/* '<S58>/Discrete Transfer Fcn' */
  ...
  real_T psi_ref_DWORK1;               /* '<S11>/psi_ref' */
  ...
  real_T DiscreteTransferFcn_tmp_f;    /* '<S77>/Discrete Transfer Fcn' */
  real_T PrevY_p;                      /* '<S77>/Acceleration Limit' */
  real_T Memory_PreviousInput_g;       /* '<S77>/Memory' */
  real_T reset_DWORK1_d;               /* '<S79>/reset' */
  real_T DiscreteTransferFcn_tmp_fg;   /* '<S54>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_k;    /* '<S86>/Discrete Transfer Fcn' */
  real_T PrevY_k;                      /* '<S86>/Acceleration limiter' */
  real_T Memory_PreviousInput_f;       /* '<S86>/Memory' */
  real_T reset_DWORK1_o;               /* '<S88>/reset' */
  real_T DiscreteTransferFcn_tmp_b;    /* '<S55>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_l;    /* '<S95>/Discrete Transfer Fcn' */
  real_T PrevY_m;                      /* '<S95>/Acceleration limiter' */
  real_T Memory_PreviousInput_d;       /* '<S95>/Memory' */
  real_T reset_DWORK1_l;               /* '<S97>/reset' */
  real_T DiscreteTransferFcn_tmp_fg5;  /* '<S56>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_i;    /* '<S104>/Discrete Transfer Fcn' */
  real_T PrevY_mo;                     /* '<S104>/Acceleration limiter' */
  real_T Memory_PreviousInput_l;       /* '<S104>/Memory' */
  real_T reset_DWORK1_dp;              /* '<S106>/reset' */
  real_T DiscreteTransferFcn_tmp_m;    /* '<S57>/Discrete Transfer Fcn' */
  real_T DiscreteTransferFcn_tmp_o;    /* '<S113>/Discrete Transfer Fcn' */
  real_T PrevY_k4;                     /* '<S113>/Acceleration limiter' */
  real_T Memory_PreviousInput_f2;      /* '<S113>/Memory' */
  real_T reset_DWORK1_dy;              /* '<S115>/reset' */
  real_T DiscreteTransferFcn_tmp_ir;   /* '<S58>/Discrete Transfer Fcn' */
  ...
  uint8_T Inputtomodel_DWORK2[26];     /* '<Root>/Input to model' */
  uint8_T OutputtoWorkspace_DWORK2[26];/* '<Root>/Output to Workspace' */
  uint8_T start_DWORK2[26];            /* '<Root>/start' */
  uint8_T K_p_x_DWORK2[26];            /* '<S18>/K_p_x' */
  uint8_T K_p_y_DWORK2[26];            /* '<S18>/K_p_y' */
  uint8_T K_p_psi_DWORK2[26];          /* '<S18>/K_p_psi' */
  uint8_T K_i_psi_DWORK2[26];          /* '<S18>/K_i_psi' */
  uint8_T K_i_x_DWORK2[26];            /* '<S18>/K_i_x' */
  uint8_T K_i_y_DWORK2[26];            /* '<S18>/K_i_y' */
  uint8_T K_d_psi_DWORK2[26];          /* '<S18>/K_d_psi' */
  uint8_T K_d_x_DWORK2[26];            /* '<S18>/K_d_x' */
  uint8_T K_d_y_DWORK2[26];            /* '<S18>/K_d_y' */
  uint8_T x_m_DWORK2[26];              /* '<S9>/x_m' */
  uint8_T y_m_DWORK2[26];              /* '<S9>/y_m' */
  uint8_T psi_m_DWORK2[26];            /* '<S9>/psi_m' */
  uint8_T Inputtomodel_DWORK2_c[26];   /* '<S12>/Input to model' */
  uint8_T Controllswitch_DWORK2[26];   /* '<Root>/Controll switch' */
  uint8_T tau_surge_DWORK2[26];        /* '<Root>/tau_surge' */
  uint8_T tau_sway_DWORK2[26];         /* '<Root>/tau_sway' */
  uint8_T start2_DWORK2[26];           /* '<Root>/start2' */
  uint8_T tau_psi_DWORK2[26];          /* '<Root>/tau_psi' */
  uint8_T psi_hat_DWORK2[26];          /* '<Root>/psi_hat' */
  uint8_T x_hat_DWORK2[26];            /* '<Root>/x_hat' */
  uint8_T y_hat_DWORK2[26];            /* '<Root>/y_hat' */
  uint8_T rpm1_DWORK2[26];             /* '<S52>/rpm1 ' */
  uint8_T rpm2_DWORK2[26];             /* '<S52>/rpm2' */
  uint8_T rpm3_DWORK2[26];             /* '<S52>/rpm3' */
  uint8_T rpm4_DWORK2[26];             /* '<S52>/rpm4' */
  uint8_T rpm5_DWORK2[26];             /* '<S52>/rpm5' */
  uint8_T rpm6_DWORK2[26];             /* '<S52>/rpm6' */
  uint8_T thr_angle_1_DWORK2[26];      /* '<S16>/thr_angle_1' */
  uint8_T thr_angle_2_DWORK2[26];      /* '<S16>/thr_angle_2' */
  uint8_T thr_angle_3_DWORK2[26];      /* '<S16>/thr_angle_3' */
  uint8_T thr_angle_4_DWORK2[26];      /* '<S16>/thr_angle_4' */
  uint8_T thr_angle_5_DWORK2[26];      /* '<S16>/thr_angle_5' */
  uint8_T thr_angle_6_DWORK2[26];      /* '<S16>/thr_angle_6' */
  uint8_T Angle_controller_DWORK2[26]; /* '<S13>/Angle_controller' */
  uint8_T tau_commanded_psi_DWORK2[26];/* '<Root>/tau_commanded_psi' */
  uint8_T tau_commanded_x_DWORK2[26];  /* '<Root>/tau_commanded_x' */
  uint8_T x_hat_DWORK2_b[26];          /* '<S32>/x_hat' */
  uint8_T y_hat_DWORK2_l[26];          /* '<S32>/y_hat' */
  uint8_T psi_hat_DWORK2_k[26];        /* '<S32>/psi_hat' */
  uint8_T u_hat_DWORK2[26];            /* '<S34>/u_hat' */
  uint8_T v_hat_DWORK2[26];            /* '<S34>/v_hat' */
  uint8_T r_hat_DWORK2[26];            /* '<S34>/r_hat' */
  uint8_T u_dot_hat_DWORK2[26];        /* '<S33>/u_dot_hat' */
  uint8_T v_dot_hat_DWORK2[26];        /* '<S33>/v_dot_hat' */
  uint8_T r_dot_hat_DWORK2[26];        /* '<S33>/r_dot_hat' */
  uint8_T b_x_hat_DWORK2[26];          /* '<S31>/b_x_hat' */
  uint8_T b_y_hat_DWORK2[26];          /* '<S31>/b_y_hat' */
  uint8_T b_psi_hat_DWORK2[26];        /* '<S31>/b_psi_hat' */
  uint8_T alpha1_DWORK2[26];           /* '<S17>/alpha1' */
  uint8_T alpha2_DWORK2[26];           /* '<S17>/alpha2' */
  uint8_T alpha3_DWORK2[26];           /* '<S17>/alpha3' */
  uint8_T alpha4_DWORK2[26];           /* '<S17>/alpha4' */
  uint8_T alpha5_DWORK2[26];           /* '<S17>/alpha5' */
  uint8_T alpha6_DWORK2[26];           /* '<S17>/alpha6' */
  uint8_T u1_DWORK2[26];               /* '<S17>/u1' */
  uint8_T u2_DWORK2[26];               /* '<S17>/u2' */
  uint8_T u3_DWORK2[26];               /* '<S17>/u3' */
  uint8_T u4_DWORK2[26];               /* '<S17>/u4' */
  uint8_T u5_DWORK2[26];               /* '<S17>/u5' */
  uint8_T u6_DWORK2[26];               /* '<S17>/u6' */
  uint8_T tau_commanded_y_DWORK2[26];  /* '<Root>/tau_commanded_y' */
  uint8_T y_error_DWORK2[26];          /* '<S7>/y_error' */
  uint8_T psi_error_DWORK2[26];        /* '<S7>/psi_error' */
  uint8_T x_error_DWORK2[26];          /* '<S7>/x_error' */
  uint8_T x_ref_DWORK2[26];            /* '<S11>/x_ref' */
  uint8_T y_ref_DWORK2[26];            /* '<S11>/y_ref' */
  uint8_T w_x_DWORK2[26];              /* '<S19>/w_x' */
  uint8_T w_y_DWORK2[26];              /* '<S19>/w_y' */
  uint8_T w_psi_DWORK2[26];            /* '<S19>/w_psi' */
  uint8_T zeta_psi_DWORK2[26];         /* '<S19>/zeta_psi' */
  uint8_T zeta_x_DWORK2[26];           /* '<S19>/zeta_x' */
  uint8_T zeta_y_DWORK2[26];           /* '<S19>/zeta_y' */
  uint8_T T_psi_DWORK2[26];            /* '<S19>/T_psi' */
  uint8_T T_x_DWORK2[26];              /* '<S19>/T_x' */
  uint8_T T_y_DWORK2[26];              /* '<S19>/T_y' */
  uint8_T psi_ref_DWORK2[26];          /* '<S11>/psi_ref' */
  uint8_T reset_DWORK2[26];            /* '<S70>/reset' */
  uint8_T Control_test_Pa_DWORK2[26];  /* '<S66>/Control_test_Pa' */
  uint8_T reset_DWORK2_k[26];          /* '<S79>/reset' */
  uint8_T reset_DWORK2_p[26];          /* '<S88>/reset' */
  uint8_T reset_DWORK2_m[26];          /* '<S97>/reset' */
  uint8_T reset_DWORK2_i[26];          /* '<S106>/reset' */
  uint8_T reset_DWORK2_j[26];          /* '<S115>/reset' */
  uint8_T Acc_x_DWORK2[26];            /* '<S1>/Acc_x' */
  uint8_T Acc_y_DWORK2[26];            /* '<S1>/Acc_y' */
  uint8_T Acc_z_DWORK2[26];            /* '<S1>/Acc_z' */
  uint8_T Gyro_x_DWORK2[26];           /* '<S1>/Gyro_x' */
  uint8_T Gyro_y_DWORK2[26];           /* '<S1>/Gyro_y' */
  uint8_T Gyro_z_DWORK2[26];           /* '<S1>/Gyro_z' */
  DW_CoreSubsys_ctrl_custom_tur_T CoreSubsys[6];/* '<S45>/CoreSubsys' */
} DW_ctrl_custom_turning_frame_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_a;          /* '<S67>/Integrator' */
  real_T Integrator_CSTATE_f;          /* '<S76>/Integrator' */
  real_T Integrator_CSTATE_ao;         /* '<S85>/Integrator' */
  real_T Integrator_CSTATE_k;          /* '<S94>/Integrator' */
  real_T Integrator_CSTATE_k2;         /* '<S103>/Integrator' */
  real_T Integrator_CSTATE_i;          /* '<S112>/Integrator' */
  real_T Integrator2_CSTATE_j[3];      /* '<S5>/Integrator2' */
  real_T Integrator_CSTATE_f5[3];      /* '<S11>/Integrator' */
  real_T Integrator_CSTATE_m;          /* '<S70>/Integrator' */
  real_T Integrator_CSTATE_ko;         /* '<S79>/Integrator' */
  real_T Integrator_CSTATE_c;          /* '<S88>/Integrator' */
  real_T Integrator_CSTATE_p;          /* '<S97>/Integrator' */
  real_T Integrator_CSTATE_n;          /* '<S106>/Integrator' */
  real_T Integrator_CSTATE_ci;         /* '<S115>/Integrator' */
} X_ctrl_custom_turning_frame_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_n;          /* '<S106>/Integrator' */
  real_T Integrator_CSTATE_ci;         /* '<S115>/Integrator' */
} XDot_ctrl_custom_turning_fram_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_a;       /* '<S67>/Integrator' */
  boolean_T Integrator_CSTATE_f;       /* '<S76>/Integrator' */
  boolean_T Integrator_CSTATE_ao;      /* '<S85>/Integrator' */
  boolean_T Integrator_CSTATE_k;       /* '<S94>/Integrator' */
  boolean_T Integrator_CSTATE_k2;      /* '<S103>/Integrator' */
  boolean_T Integrator_CSTATE_i;       /* '<S112>/Integrator' */
  boolean_T Integrator2_CSTATE_j[3];   /* '<S5>/Integrator2' */
  boolean_T Integrator_CSTATE_f5[3];   /* '<S11>/Integrator' */
  boolean_T Integrator_CSTATE_m;       /* '<S70>/Integrator' */
  boolean_T Integrator_CSTATE_ko;      /* '<S79>/Integrator' */
  boolean_T Integrator_CSTATE_c;       /* '<S88>/Integrator' */
  boolean_T Integrator_CSTATE_p;       /* '<S97>/Integrator' */
  boolean_T Integrator_CSTATE_n;       /* '<S106>/Integrator' */
  boolean_T Integrator_CSTATE_ci;      /* '<S115>/Integrator' */
} XDis_ctrl_custom_turning_fram_T;
...
typedef struct {
  ...
  ZCSigState Integrator_Reset_ZCE_g;   /* '<S67>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_n;   /* '<S76>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_e;   /* '<S85>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_l;   /* '<S94>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_j;   /* '<S103>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_m;   /* '<S112>/Integrator' */
  ZCSigState Integrator2_Reset_ZCE;    /* '<S5>/Integrator2' */
  ZCSigState Integrator_Reset_ZCE_lk;  /* '<S70>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_p;   /* '<S79>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_gm;  /* '<S88>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_ja;  /* '<S97>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_i;   /* '<S106>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_b;   /* '<S115>/Integrator' */
} PrevZCX_ctrl_custom_turning_f_T;
...
#define rtB                            ctrl_custom_turning_frame_B
#define BlockIO                        B_ctrl_custom_turning_frame_T
#define rtX                            ctrl_custom_turning_frame_X
#define ContinuousStates               X_ctrl_custom_turning_frame_T
#define rtXdot                         ctrl_custom_turning_frame_XDot
#define StateDerivatives               XDot_ctrl_custom_turning_fram_T
#define tXdis                          ctrl_custom_turning_frame_XDis
#define StateDisabled                  XDis_ctrl_custom_turning_fram_T
#define rtP                            ctrl_custom_turning_frame_P
#define Parameters                     P_ctrl_custom_turning_frame_T
#define rtDWork                        ctrl_custom_turning_frame_DW
#define D_Work                         DW_ctrl_custom_turning_frame_T
#define rtPrevZCSigState               ctrl_custom_turning_fra_PrevZCX
#define PrevZCSigStates                PrevZCX_ctrl_custom_turning_f_T

/* Parameters for system: '<S45>/CoreSubsys' */
struct P_CoreSubsys_ctrl_custom_turn_T_ {
...
struct P_ctrl_custom_turning_frame_T_ {
  ...
  uint32_T Delay_DelayLength_hw;       /* Computed Parameter: Delay_DelayLength_hw
                                        * Referenced by: '<S113>/Delay'
                                        */
  P_CoreSubsys_ctrl_custom_turn_T CoreSubsys;/* '<S45>/CoreSubsys' */
};

/* Real-time Model Data Structure */
struct tag_RTM_ctrl_custom_turning_f_T {
  const char_T *path;
...
extern P_ctrl_custom_turning_frame_T ctrl_custom_turning_frame_P;

/* Block signals (auto storage) */
extern B_ctrl_custom_turning_frame_T ctrl_custom_turning_frame_B;

/* Continuous states (auto storage) */
extern X_ctrl_custom_turning_frame_T ctrl_custom_turning_frame_X;

/* Block states (auto storage) */
extern DW_ctrl_custom_turning_frame_T ctrl_custom_turning_frame_DW;

/* External data declarations for dependent source files */
extern const real_T ctrl_custom_turning_frame_RGND;/* real_T ground */

/* Model entry point functions */
extern void ctrl_custom_turning_frame_initialize(void);
extern void ctrl_custom_turning_frame_output(void);
extern void ctrl_custom_turning_frame_update(void);
extern void ctrl_custom_turning_frame_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern ctrl_custom_turning_frame_rtModel *ctrl_custom_turning_frame(void);
...
extern RT_MODEL_ctrl_custom_turning__T *const ctrl_custom_turning_frame_M;
 ...
 *
 * '<Root>' : 'ctrl_custom_turning_frame'
 * '<S1>'   : 'ctrl_custom_turning_frame/IMU'
 * '<S2>'   : 'ctrl_custom_turning_frame/Initialization of parameters'
 * '<S3>'   : 'ctrl_custom_turning_frame/MATLAB Function'
 * '<S4>'   : 'ctrl_custom_turning_frame/Model Info'
 * '<S5>'   : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer'
 * '<S6>'   : 'ctrl_custom_turning_frame/Observer output '
 * '<S7>'   : 'ctrl_custom_turning_frame/PID controller'
 * '<S8>'   : 'ctrl_custom_turning_frame/PID controller1'
 * '<S9>'   : 'ctrl_custom_turning_frame/Pose'
 * '<S10>'  : 'ctrl_custom_turning_frame/Radians to Degrees'
 * '<S11>'  : 'ctrl_custom_turning_frame/Referance'
 * '<S12>'  : 'ctrl_custom_turning_frame/Reference basin'
 * '<S13>'  : 'ctrl_custom_turning_frame/Thrust allocation'
 * '<S14>'  : 'ctrl_custom_turning_frame/Thruster Parameters '
 * '<S15>'  : 'ctrl_custom_turning_frame/Thruster control '
 * '<S16>'  : 'ctrl_custom_turning_frame/Thruster measurment'
 * '<S17>'  : 'ctrl_custom_turning_frame/gain'
 * '<S18>'  : 'ctrl_custom_turning_frame/Initialization of parameters/Control Gains'
 * '<S19>'  : 'ctrl_custom_turning_frame/Initialization of parameters/Guidance Gains'
 * '<S20>'  : 'ctrl_custom_turning_frame/Initialization of parameters/Observer Gains'
 * '<S21>'  : 'ctrl_custom_turning_frame/Initialization of parameters/Guidance Gains/MATLAB Function'
 * '<S22>'  : 'ctrl_custom_turning_frame/Initialization of parameters/Guidance Gains/MATLAB Function1'
 * '<S23>'  : 'ctrl_custom_turning_frame/Initialization of parameters/Guidance Gains/MATLAB Function2'
 * '<S24>'  : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer/C(nu)*nu'
 * '<S25>'  : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer/D(nu)*nu'
 * '<S26>'  : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer/Rotation matrix in yaw 1'
 * '<S27>'  : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer/Transpose Rotation Matrix'
 * '<S28>'  : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer/Transpose Rotation matrix'
 * '<S29>'  : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]'
 * '<S30>'  : 'ctrl_custom_turning_frame/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]1'
 * '<S31>'  : 'ctrl_custom_turning_frame/Observer output /b_hat output'
 * '<S32>'  : 'ctrl_custom_turning_frame/Observer output /eta_hat output'
 * '<S33>'  : 'ctrl_custom_turning_frame/Observer output /nu_dot_hat output'
 * '<S34>'  : 'ctrl_custom_turning_frame/Observer output /nu_hat output'
 * '<S35>'  : 'ctrl_custom_turning_frame/PID controller/Transposed rotation  matrix in yaw1'
 * '<S36>'  : 'ctrl_custom_turning_frame/PID controller/Transposed rotation  matrix in yaw2'
 * '<S37>'  : 'ctrl_custom_turning_frame/PID controller/[-inf inf] to [-pi pi]'
 * '<S38>'  : 'ctrl_custom_turning_frame/PID controller/[-inf inf] to [-pi pi]1'
 * '<S39>'  : 'ctrl_custom_turning_frame/PID controller1/[-inf inf] to [-pi pi]'
 * '<S40>'  : 'ctrl_custom_turning_frame/Referance/MATLAB Function'
 * '<S41>'  : 'ctrl_custom_turning_frame/Referance/MATLAB Function1'
 * '<S42>'  : 'ctrl_custom_turning_frame/Referance/MATLAB Function2'
 * '<S43>'  : 'ctrl_custom_turning_frame/Referance/[-inf inf] to [-pi pi]'
 * '<S44>'  : 'ctrl_custom_turning_frame/Thrust allocation/MATLAB Function'
 * '<S45>'  : 'ctrl_custom_turning_frame/Thrust allocation/Optimal angle path and  constraints on rotation speed'
 * '<S46>'  : 'ctrl_custom_turning_frame/Thrust allocation/Radians to Degrees'
 * '<S47>'  : 'ctrl_custom_turning_frame/Thrust allocation/angle between  [-180 180]'
 * '<S48>'  : 'ctrl_custom_turning_frame/Thrust allocation/Optimal angle path and  constraints on rotation speed/Degrees to Radians'
 * '<S49>'  : 'ctrl_custom_turning_frame/Thrust allocation/Optimal angle path and  constraints on rotation speed/Ensuring angle is  [-pi pi]'
 * '<S50>'  : 'ctrl_custom_turning_frame/Thrust allocation/Optimal angle path and  constraints on rotation speed/MATLAB Function1'
 * '<S51>'  : 'ctrl_custom_turning_frame/Thruster control /Subsystem1'
 * '<S52>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM'
 * '<S53>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1'
 * '<S54>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2'
 * '<S55>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3'
 * '<S56>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4'
 * '<S57>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 5'
 * '<S58>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 6'
 * '<S59>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function'
 * '<S60>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function1'
 * '<S61>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function2'
 * '<S62>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function3'
 * '<S63>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function4'
 * '<S64>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function5'
 * '<S65>'  : 'ctrl_custom_turning_frame/Thruster control /Thrust and Shaft speed mapped to PWM/MATLAB Function6'
 * '<S66>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Propeller Hydrodynamics'
 * '<S67>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Shaft dynamics'
 * '<S68>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Thruster control'
 * '<S69>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S70>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Thruster control/Core controller'
 * '<S71>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Thruster control/Discrete Derivative'
 * '<S72>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Thruster control/MATLAB Function'
 * '<S73>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Thruster control/Supervisor'
 * '<S74>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 1/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S75>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Propeller Hydrodynamics'
 * '<S76>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Shaft dynamics'
 * '<S77>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Thruster control'
 * '<S78>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S79>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Thruster control/Core controller'
 * '<S80>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Thruster control/Discrete Derivative'
 * '<S81>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Thruster control/MATLAB Function'
 * '<S82>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Thruster control/Supervisor'
 * '<S83>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 2/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S84>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Propeller Hydrodynamics'
 * '<S85>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Shaft dynamics'
 * '<S86>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Thruster control'
 * '<S87>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S88>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Thruster control/Core controller'
 * '<S89>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Thruster control/Discrete Derivative'
 * '<S90>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Thruster control/MATLAB Function'
 * '<S91>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Thruster control/Supervisor'
 * '<S92>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 3/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S93>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Propeller Hydrodynamics'
 * '<S94>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Shaft dynamics'
 * '<S95>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Thruster control'
 * '<S96>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S97>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Thruster control/Core controller'
 * '<S98>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Thruster control/Discrete Derivative'
 * '<S99>'  : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Thruster control/MATLAB Function'
 * '<S100>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Thruster control/Supervisor'
 * '<S101>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 4/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S102>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Propeller Hydrodynamics'
 * '<S103>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Shaft dynamics'
 * '<S104>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Thruster control'
 * '<S105>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S106>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Thruster control/Core controller'
 * '<S107>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Thruster control/Discrete Derivative'
 * '<S108>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Thruster control/MATLAB Function'
 * '<S109>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Thruster control/Supervisor'
 * '<S110>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 5/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 * '<S111>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Propeller Hydrodynamics'
 * '<S112>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Shaft dynamics'
 * '<S113>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Thruster control'
 * '<S114>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Propeller Hydrodynamics/Actual Force and Torque'
 * '<S115>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Thruster control/Core controller'
 * '<S116>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Thruster control/Discrete Derivative'
 * '<S117>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Thruster control/MATLAB Function'
 * '<S118>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Thruster control/Supervisor'
 * '<S119>' : 'ctrl_custom_turning_frame/Thruster control /Thruster 6/Thruster control/Core controller/Core controller: Torque,Power and Combined Torque//Power'
 */
#endif                                 /* RTW_HEADER_ctrl_custom_turning_frame_h_ */
 ...
 *========================================================================*/
#if !defined(NI_HEADER_ctrl_custom_turning_frame_h_)
#define NI_HEADER_ctrl_custom_turning_frame_h_
...
/* ctrl_custom_turning_frame.c definitions */
int READSIDE = 0;
int tid = 0;
...
/* multi-rate model */
P_ctrl_custom_turning_frame_T rtParameter[NUMST+!TID01EQ];
P_ctrl_custom_turning_frame_T *param_lookup[NUMST][2] = {
...
/* single-rate model */
P_ctrl_custom_turning_frame_T rtParameter[2];
...
/* multi-rate model */
extern int tid;
extern P_ctrl_custom_turning_frame_T* param_lookup[NUMST][2];

#else

/* single-rate model */
extern P_ctrl_custom_turning_frame_T rtParameter[];
...
#endif
#endif
#endif                                 /* NI_HEADER_ctrl_custom_turning_frame_h_ */
