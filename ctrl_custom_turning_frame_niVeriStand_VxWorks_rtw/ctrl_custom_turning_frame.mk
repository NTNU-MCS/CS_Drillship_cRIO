# File    : ctrl_custom_turning_frame.mk (for Release 2010b and later)
#
# Abstract:
...
MODULES         		= ctrl_custom_turning_frame_data.c ni_modelframework.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c rt_zcfcn.c 
MAKEFILE        		= ctrl_custom_turning_frame.mk
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= C:/Users/MCLab/Documents/GitHub/CS_Drillship_cRIO
S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
NUMST           		= 2
...
MODELLIB                  = ctrl_custom_turning_framelib.lib
MODELREF_LINK_LIBS   	  = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/ctrl_custom_turning_frame_niVeriStand_VxWorks_rtw \
	-I$(START_DIR) \
	-I$(START_DIR)/Test \
