 ...
 *    '<S9>/MATLAB Function'
 */
void ctrl_custom_MATLABFunction(real_T rtu_X_limit, real_T rtu_X_unsaturated,
  B_MATLABFunction_ctrl_custom_T *localB)
{
  /* MATLAB Function 'Regulator 2 psi/MATLAB Function': '<S17>:1' */
  if (rtu_X_unsaturated > rtu_X_limit) {
    /* '<S17>:1:4' */
    /* '<S17>:1:5' */
    localB->X = rtu_X_limit;
  } else if (rtu_X_unsaturated < -rtu_X_limit) {
    /* '<S17>:1:6' */
    /* '<S17>:1:7' */
    localB->X = -rtu_X_limit;
  } else {
    /* '<S17>:1:9' */
    localB->X = rtu_X_unsaturated;
  }
}
...
void ctrl_custom_output(void)
{
  ...
  ctrl_custom_B.Integrator = ctrl_custom_X.Integrator_CSTATE;

  /* Sum: '<Root>/Sum' incorporates:
   *  Gain: '<S13>/mm2m'
   */
  ctrl_custom_B.Sum = ctrl_custom_P.mm2m_Gain * ctrl_custom_B.x_m +
    ctrl_custom_B.Integrator;
  ...
  /* Sum: '<S13>/Sum' */
  ctrl_custom_B.Sum_f = rtb_Integrator2_m - rtb_Integrator;
  ...
  /* '<S2>:1:3' */
  ctrl_custom_B.eta_tilde[0] = ctrl_custom_B.x_ref - ctrl_custom_B.Sum;
  ctrl_custom_B.eta_tilde[1] = ctrl_custom_B.y_ref - ctrl_custom_B.Gain1;
  ctrl_custom_B.eta_tilde[2] = ctrl_custom_B.deg2rad - ctrl_custom_B.Sum_f;

  /*  body frame error */
  /* '<S2>:1:6' */
  /* '<S2>:1:7' */
  tmp[0] = cos(ctrl_custom_B.Sum_f);
  tmp[3] = sin(ctrl_custom_B.Sum_f);
  tmp[6] = 0.0;
  tmp[1] = -sin(ctrl_custom_B.Sum_f);
  tmp[4] = cos(ctrl_custom_B.Sum_f);
  tmp[7] = 0.0;
  tmp[2] = 0.0;
  tmp[5] = 0.0;
  tmp[8] = 1.0;
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    if (zcEvent != NO_ZCEVENT) {
      ctrl_custom_X.Integrator_CSTATE_k = ctrl_custom_P.Integrator_IC_a;
    }
  }
   ...
   *  Sum: '<S8>/Sum2'
   */
  rtb_Integrator2_m = ((ctrl_custom_B.k2_x * ctrl_custom_X.Integrator_CSTATE_k +
  ...
  ctrl_custom_MATLABFunction(ctrl_custom_B.X_limit, ctrl_custom_B.Sum3,
    &ctrl_custom_B.sf_MATLABFunction);
  ...
  ctrl_custom_MATLABFunction(ctrl_custom_B.Y_limit, ctrl_custom_B.Sum3_k,
    &ctrl_custom_B.sf_MATLABFunction_n);
  ...
  ctrl_custom_MATLABFunction(ctrl_custom_B.N_limit, ctrl_custom_B.Sum3_o,
    &ctrl_custom_B.sf_MATLABFunction_c);

  /* Gain: '<S10>/Gain' incorporates:
   *  SignalConversion: '<S10>/TmpSignal ConversionAtGainInport1'
   */
  for (i = 0; i < 12; i++) {
    rtb_u_e[i] = ctrl_custom_P.T_pinv[i + 24] *
      ctrl_custom_B.sf_MATLABFunction_c.X + (ctrl_custom_P.T_pinv[i + 12] *
      ctrl_custom_B.sf_MATLABFunction_n.X + ctrl_custom_P.T_pinv[i] *
      ctrl_custom_B.sf_MATLABFunction.X);
  }

  /* End of Gain: '<S10>/Gain' */

  /* MATLAB Function: '<S10>/MATLAB Function11' */
  /* MATLAB Function 'Thrust allocation: Pseudo-inverse of extended thrust configuration matrix/MATLAB Function11': '<S20>:1' */
  /* '<S20>:1:2' */
  ...
  rtb_TmpSignalConversionAtSFunct[1] = ctrl_custom_B.alpha2_rad;
  rtb_TmpSignalConversionAtSFunct[2] = ctrl_custom_B.alpha3_rad;
  rtb_TmpSignalConversionAtSFunct[3] = ctrl_custom_B.alpha4_rad;
  rtb_TmpSignalConversionAtSFunct[4] = ctrl_custom_B.alpha5_rad;
  rtb_TmpSignalConversionAtSFunct[5] = ctrl_custom_B.alpha6_rad;

  /* MATLAB Function: '<S6>/MATLAB Function11' */
  /* MATLAB Function 'Projection [-pi,pi] to [-inf,inf] + shortest rotation/MATLAB Function11': '<S16>:1' */
  /* '<S16>:1:1' */
  /* '<S16>:1:4' */
  for (i = 0; i < 6; i++) {
    /* '<S16>:1:4' */
    ...
    if (rtb_TmpSignalConversionAtSFunct[i] < 0.0) {
      ...
      alpha_tilde = rtb_TmpSignalConversionAtSFunct[i];
    }

    ctrl_custom_B.alpha_infinf[i] = floor((fabs
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    rtb_eta_ref[0] = ctrl_custom_B.sf_MATLABFunction.X;
    rtb_eta_ref[1] = ctrl_custom_B.sf_MATLABFunction_n.X;
    rtb_eta_ref[2] = ctrl_custom_B.sf_MATLABFunction_c.X;
    ...
    rtb_eta_ref[0] = ctrl_custom_B.Sum;
    rtb_eta_ref[1] = ctrl_custom_B.Gain1;
    rtb_eta_ref[2] = ctrl_custom_B.Sum_f;
   ...
   *  Sum: '<S7>/Sum4'
   */
  ctrl_custom_B.Sum5 = (ctrl_custom_B.Sum3_o -
                        ctrl_custom_B.sf_MATLABFunction_c.X) *
  ...
  ctrl_custom_B.Sum_e = (ctrl_custom_B.sigma_x * ctrl_custom_B.eta_tilde[0] *
    ctrl_custom_B.k2_x + ctrl_custom_X.Integrator_CSTATE_k) +
   ...
   *  Sum: '<S8>/Sum4'
   */
  ctrl_custom_B.Sum5_b = (ctrl_custom_B.Sum3 - ctrl_custom_B.sf_MATLABFunction.X)
   ...
   *  Sum: '<S9>/Sum4'
   */
  ctrl_custom_B.Sum5_e = (ctrl_custom_B.Sum3_k -
    ctrl_custom_B.sf_MATLABFunction_n.X) * ctrl_custom_B.nu_y - rtb_Integrator;
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    /* Memory: '<S12>/Memory' */
  ...
  /* MATLAB Function 'current emulator/MATLAB Function': '<S21>:1' */
  /* current_sign = current_sign_prev; */
  if (ctrl_custom_B.Integrator >= ctrl_custom_B.currentoffsetmax) {
    /* '<S21>:1:4' */
    /* '<S21>:1:5' */
    ctrl_custom_B.current_sign = -1.0;
  } else if (ctrl_custom_B.Integrator <= ctrl_custom_B.currentoffsetmin) {
    /* '<S21>:1:6' */
    /* '<S21>:1:7' */
    ctrl_custom_B.current_sign = 1.0;
  } else {
    /* '<S21>:1:9' */
    ctrl_custom_B.current_sign = ctrl_custom_B.Memory;
  }

  /* End of MATLAB Function: '<S12>/MATLAB Function' */

  /* Product: '<S12>/Product' */
  ctrl_custom_B.Product = ctrl_custom_B.currentvelocity *
    ctrl_custom_B.current_sign;
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
  }
}
...
void ctrl_custom_update(void)
{
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_DW.Memory_PreviousInput = ctrl_custom_B.current_sign;
  }
...
void ctrl_custom_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = ctrl_custom_B.Product;

  /* Derivatives for Integrator: '<S8>/Integrator' */
  _rtXdot->Integrator_CSTATE_k = ctrl_custom_B.Sum1_j;
...
RT_MODEL_ctrl_custom_T *ctrl_custom(void)
{
  ...
  ctrl_custom_M->Sizes.numBlocks = (193);/* Number of blocks */
  ctrl_custom_M->Sizes.numBlockIO = (73);/* Number of block outputs */
  ctrl_custom_M->Sizes.numBlockPrms = (481);/* Sum of parameter "widths" */
...
void SetExternalInputs(double* data, int_T* TaskSampleHit)
{
  ...
  // ctrl_custom/alpha_m/alpha1_rad
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.alpha1_rad, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/alpha_m/alpha2_rad
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.alpha2_rad, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/alpha_m/alpha3_rad
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.alpha3_rad, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/alpha_m/alpha4_rad
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.alpha4_rad, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/alpha_m/alpha5_rad
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.alpha5_rad, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/alpha_m/alpha6_rad
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.alpha6_rad, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Regulator 2 x/X_limit
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.X_limit, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
  ...
  // ctrl_custom/Regulator 2 y/Y_limit
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.Y_limit, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
  ...
  // ctrl_custom/Regulator 2 psi/N_limit
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.N_limit, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
  ...
  // ctrl_custom/current emulator/current velocity
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.currentvelocity, 0, data[index++], 0,
      0);
  } else {
    index += 1;
  }

  // ctrl_custom/current emulator/current offset max
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.currentoffsetmax, 0, data[index++], 0,
      0);
  } else {
    index += 1;
  }

  // ctrl_custom/current emulator/current offset min
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.currentoffsetmin, 0, data[index++], 0,
      0);
  } else {
    index += 1;
  }
...
void SetExternalOutputs(double* data, int_T* TaskSampleHit)
{
  ...
  // ctrl_custom/x_biased: Virtual Signal # 0
  ...
  // ctrl_custom/x_bias: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_custom_B.Integrator, 0, 0,
      0);
  } else {
    index += 1;
  }

  // ctrl_custom/Regulator 2 x/X_saturated: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_custom_B.sf_MATLABFunction.X, 0, 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Regulator 2 x/X_unsaturated: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_custom_B.Sum3, 0, 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Regulator 2 y/Y_saturated: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_custom_B.sf_MATLABFunction_n.X, 0, 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Regulator 2 y/Y_unsaturated: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_custom_B.Sum3_k, 0, 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Regulator 2 psi/N_saturated: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType
      (&ctrl_custom_B.sf_MATLABFunction_c.X, 0, 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Regulator 2 psi/N_unsaturated: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_custom_B.Sum3_o, 0, 0, 0);
  } else {
    index += 1;
  }
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  { 0,
    ...
    offsetof(P_ctrl_custom_T, T_pinv), 26, 36, 2, 0, 0 },

  { 1, "ctrl_custom/current emulator/Integrator/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator_IC), 36, 1, 2, 2, 0 },

  { 2, "ctrl_custom/eta_QTM/mm2m/Gain", offsetof(P_ctrl_custom_T, mm2m_Gain), 36,
    1, 2, 4, 0 },

  { 3, "ctrl_custom/deg2rad/Gain", offsetof(P_ctrl_custom_T, deg2rad_Gain), 36,
    1, 2, 6, 0 },
  ...
  { 9, "ctrl_custom/eta_QTM/Constant1/Value", offsetof(P_ctrl_custom_T,
    Constant1_Value), 36, 1, 2, 18, 0 },

  { 10, "ctrl_custom/Regulator 2 x/Integrator/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator_IC_a), 36, 1, 2, 20, 0 },

  { 11, "ctrl_custom/Regulator 2 x/Integrator2/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator2_IC), 36, 1, 2, 22, 0 },

  { 12, "ctrl_custom/Regulator 2 x/Integrator1/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator1_IC), 36, 1, 2, 24, 0 },

  { 13, "ctrl_custom/Regulator 2 y/Integrator/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator_IC_l), 36, 1, 2, 26, 0 },

  { 14, "ctrl_custom/Regulator 2 y/Integrator2/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator2_IC_k), 36, 1, 2, 28, 0 },

  { 15, "ctrl_custom/Regulator 2 y/Integrator1/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator1_IC_p), 36, 1, 2, 30, 0 },

  { 16, "ctrl_custom/Regulator 2 psi/Integrator/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator_IC_lf), 36, 1, 2, 32, 0 },

  { 17, "ctrl_custom/Regulator 2 psi/Integrator2/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator2_IC_e), 36, 1, 2, 34, 0 },

  { 18, "ctrl_custom/Regulator 2 psi/Integrator1/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator1_IC_pm), 36, 1, 2, 36, 0 },

  { 19, "ctrl_custom/Regulator 2 psi/Gain1/Gain", offsetof(P_ctrl_custom_T,
    Gain1_Gain_b), 36, 1, 2, 38, 0 },

  { 20, "ctrl_custom/Regulator 2 psi/Gain2/Gain", offsetof(P_ctrl_custom_T,
    Gain2_Gain), 36, 1, 2, 40, 0 },

  { 21, "ctrl_custom/Regulator 2 x/Gain1/Gain", offsetof(P_ctrl_custom_T,
    Gain1_Gain_bw), 36, 1, 2, 42, 0 },

  { 22, "ctrl_custom/Regulator 2 x/Gain2/Gain", offsetof(P_ctrl_custom_T,
    Gain2_Gain_f), 36, 1, 2, 44, 0 },

  { 23, "ctrl_custom/Regulator 2 y/Gain1/Gain", offsetof(P_ctrl_custom_T,
    Gain1_Gain_c), 36, 1, 2, 46, 0 },

  { 24, "ctrl_custom/Regulator 2 y/Gain2/Gain", offsetof(P_ctrl_custom_T,
    Gain2_Gain_c), 36, 1, 2, 48, 0 },

  { 25, "ctrl_custom/current emulator/Memory/X0", offsetof(P_ctrl_custom_T,
    Memory_X0), 36, 1, 2, 50, 0 },
};

static int32_t NI_ParamListSize DataSection(".NIVS.paramlistsize") = 26;
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 1, "ctrl_custom/current emulator/Integrator", 0, "", offsetof
    (B_ctrl_custom_T, Integrator) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 2, "ctrl_custom/eta_QTM/x_m", 0, "", offsetof(B_ctrl_custom_T, x_m) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 3, "ctrl_custom/Sum", 0, "", offsetof(B_ctrl_custom_T, Sum) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 4, "ctrl_custom/x_ref", 0, "", offsetof(B_ctrl_custom_T, x_ref) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 5, "ctrl_custom/y_ref", 0, "", offsetof(B_ctrl_custom_T, y_ref) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 6, "ctrl_custom/alpha_m/alpha1_rad", 0, "", offsetof(B_ctrl_custom_T,
    alpha1_rad) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 7, "ctrl_custom/alpha_m/alpha2_rad", 0, "", offsetof(B_ctrl_custom_T,
    alpha2_rad) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 8, "ctrl_custom/alpha_m/alpha3_rad", 0, "", offsetof(B_ctrl_custom_T,
    alpha3_rad) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 9, "ctrl_custom/alpha_m/alpha4_rad", 0, "", offsetof(B_ctrl_custom_T,
    alpha4_rad) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 10, "ctrl_custom/alpha_m/alpha5_rad", 0, "", offsetof(B_ctrl_custom_T,
    alpha5_rad) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 11, "ctrl_custom/alpha_m/alpha6_rad", 0, "", offsetof(B_ctrl_custom_T,
    alpha6_rad) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 12, "ctrl_custom/Regulator 2 x/X_limit", 0, "", offsetof(B_ctrl_custom_T,
    X_limit) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 13, "ctrl_custom/Regulator 2 x/k0_x", 0, "", offsetof(B_ctrl_custom_T, k0_x)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 14, "ctrl_custom/psi_ref [deg]", 0, "", offsetof(B_ctrl_custom_T, psi_refdeg)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 15, "ctrl_custom/deg2rad", 0, "", offsetof(B_ctrl_custom_T, deg2rad) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 16, "ctrl_custom/eta_QTM/y_m", 0, "", offsetof(B_ctrl_custom_T, y_m) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 17, "ctrl_custom/eta_QTM/Gain1", 0, "", offsetof(B_ctrl_custom_T, Gain1) +
    (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 18, "ctrl_custom/eta_QTM/psi_m", 0, "[-180,180] [deg]", offsetof
    (B_ctrl_custom_T, u80180deg) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 19, "ctrl_custom/eta_QTM/Sum", 0, "", offsetof(B_ctrl_custom_T, Sum_f) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 20, "ctrl_custom/Regulator 2 x/k2_x", 0, "", offsetof(B_ctrl_custom_T, k2_x)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 21, "ctrl_custom/Regulator 2 x/reset", 0, "", offsetof(B_ctrl_custom_T,
    reset) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 22, "ctrl_custom/Regulator 2 x/k1_x", 0, "", offsetof(B_ctrl_custom_T, k1_x)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 23, "ctrl_custom/Regulator 2 x/gamma_x", 0, "", offsetof(B_ctrl_custom_T,
    gamma_x) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 24, "ctrl_custom/Regulator 2 x/Sum3", 0, "", offsetof(B_ctrl_custom_T, Sum3)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 25, "ctrl_custom/Regulator 2 x/sigma_x", 0, "", offsetof(B_ctrl_custom_T,
    sigma_x) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 26, "ctrl_custom/Regulator 2 x/nu_x", 0, "", offsetof(B_ctrl_custom_T, nu_x)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 27, "ctrl_custom/Regulator 2 y/Y_limit", 0, "", offsetof(B_ctrl_custom_T,
    Y_limit) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 28, "ctrl_custom/Regulator 2 y/k0_y", 0, "", offsetof(B_ctrl_custom_T, k0_y)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 29, "ctrl_custom/Regulator 2 y/k2_y", 0, "", offsetof(B_ctrl_custom_T, k2_y)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 30, "ctrl_custom/Regulator 2 y/reset", 0, "", offsetof(B_ctrl_custom_T,
    reset_l) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 31, "ctrl_custom/Regulator 2 y/k1_y", 0, "", offsetof(B_ctrl_custom_T, k1_y)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 32, "ctrl_custom/Regulator 2 y/gamma_y", 0, "", offsetof(B_ctrl_custom_T,
  ...
  { 34, "ctrl_custom/Regulator 2 y/sigma_y", 0, "", offsetof(B_ctrl_custom_T,
    sigma_y) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 35, "ctrl_custom/Regulator 2 y/nu_y", 0, "", offsetof(B_ctrl_custom_T, nu_y)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 36, "ctrl_custom/Regulator 2 psi/N_limit", 0, "", offsetof(B_ctrl_custom_T,
    N_limit) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 37, "ctrl_custom/Regulator 2 psi/k0_psi", 0, "", offsetof(B_ctrl_custom_T,
    k0_psi) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 38, "ctrl_custom/Regulator 2 psi/k2_psi", 0, "", offsetof(B_ctrl_custom_T,
    k2_psi) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 39, "ctrl_custom/Regulator 2 psi/reset", 0, "", offsetof(B_ctrl_custom_T,
    reset_d) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 40, "ctrl_custom/Regulator 2 psi/k1_psi", 0, "", offsetof(B_ctrl_custom_T,
    k1_psi) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 41, "ctrl_custom/Regulator 2 psi/gamma_psi", 0, "", offsetof(B_ctrl_custom_T,
  ...
  { 43, "ctrl_custom/Regulator 2 psi/sigma_psi", 0, "", offsetof(B_ctrl_custom_T,
  ...
  { 45, "ctrl_custom/Regulator 2 psi/Sum", 0, "", offsetof(B_ctrl_custom_T,
    Sum_n) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 46, "ctrl_custom/Regulator 2 psi/Sum1", 0, "", offsetof(B_ctrl_custom_T,
    Sum1) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 47, "ctrl_custom/Regulator 2 psi/Sum5", 0, "", offsetof(B_ctrl_custom_T,
    Sum5) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 48, "ctrl_custom/Regulator 2 x/Sum", 0, "", offsetof(B_ctrl_custom_T, Sum_e)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 49, "ctrl_custom/Regulator 2 x/Sum1", 0, "", offsetof(B_ctrl_custom_T,
    Sum1_j) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 50, "ctrl_custom/Regulator 2 x/Sum5", 0, "", offsetof(B_ctrl_custom_T,
    Sum5_b) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 51, "ctrl_custom/Regulator 2 y/Sum", 0, "", offsetof(B_ctrl_custom_T, Sum_h)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 52, "ctrl_custom/Regulator 2 y/Sum1", 0, "", offsetof(B_ctrl_custom_T,
    Sum1_o) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 53, "ctrl_custom/Regulator 2 y/Sum5", 0, "", offsetof(B_ctrl_custom_T,
    Sum5_e) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 54, "ctrl_custom/current emulator/current velocity", 0, "", offsetof
    (B_ctrl_custom_T, currentvelocity) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 55, "ctrl_custom/current emulator/current offset max", 0, "", offsetof
    (B_ctrl_custom_T, currentoffsetmax) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 56, "ctrl_custom/current emulator/current offset min", 0, "", offsetof
    (B_ctrl_custom_T, currentoffsetmin) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 57, "ctrl_custom/current emulator/Memory", 0, "", offsetof(B_ctrl_custom_T,
    Memory) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 58, "ctrl_custom/current emulator/Product", 0, "", offsetof(B_ctrl_custom_T,
  ...
  { 61, "ctrl_custom/IMU/Acc_z", 0, "", offsetof(B_ctrl_custom_T, Acc_z) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 62, "ctrl_custom/IMU/Gyro_x", 0, "", offsetof(B_ctrl_custom_T, Gyro_x) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 63, "ctrl_custom/IMU/Gyro_y", 0, "", offsetof(B_ctrl_custom_T, Gyro_y) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 64, "ctrl_custom/IMU/Gyro_z", 0, "", offsetof(B_ctrl_custom_T, Gyro_z) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 65, "ctrl_custom/current emulator/MATLAB Function", 0, "", offsetof
    (B_ctrl_custom_T, current_sign) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },
  ...
  { 87, "ctrl_custom/Regulator 2 y/MATLAB Function", 0, "", offsetof
    (B_ctrl_custom_T, sf_MATLABFunction_n.X) + (0*sizeof(real_T)), BLOCKIO_SIG,
    0, 1, 2, 0, 0 },

  { 88, "ctrl_custom/Regulator 2 x/MATLAB Function", 0, "", offsetof
    (B_ctrl_custom_T, sf_MATLABFunction.X) + (0*sizeof(real_T)), BLOCKIO_SIG, 0,
    1, 2, 0, 0 },

  { 89, "ctrl_custom/Regulator 2 psi/MATLAB Function", 0, "", offsetof
    (B_ctrl_custom_T, sf_MATLABFunction_c.X) + (0*sizeof(real_T)), BLOCKIO_SIG,
    0, 1, 2, 0, 0 },

  { -1, "", -1, "", 0, 0, 0 }
};

static int32_t NI_SigListSize DataSection(".NIVS.siglistsize") = 90;
static int32_t NI_VirtualBlockSources[1];
static int32_t NI_SigDimList[] DataSection(".NIVS.sigdimlist") =
{ 1, 1
};

static int32_t NI_ExtListSize DataSection(".NIVS.extlistsize") = 70;
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  { 1, "Input to model", 1, EXT_IN, 1, 1, 1 },

  { 2, "eta_QTM/x_m", 0, EXT_IN, 1, 1, 1 },

  { 3, "x_ref", 0, EXT_IN, 1, 1, 1 },

  { 4, "y_ref", 0, EXT_IN, 1, 1, 1 },

  { 5, "alpha_m/alpha1_rad", 0, EXT_IN, 1, 1, 1 },

  { 6, "alpha_m/alpha2_rad", 0, EXT_IN, 1, 1, 1 },

  { 7, "alpha_m/alpha3_rad", 0, EXT_IN, 1, 1, 1 },

  { 8, "alpha_m/alpha4_rad", 0, EXT_IN, 1, 1, 1 },

  { 9, "alpha_m/alpha5_rad", 0, EXT_IN, 1, 1, 1 },

  { 10, "alpha_m/alpha6_rad", 0, EXT_IN, 1, 1, 1 },

  { 11, "Regulator 2 x/X_limit", 0, EXT_IN, 1, 1, 1 },

  { 12, "Regulator 2 x/k0_x", 0, EXT_IN, 1, 1, 1 },

  { 13, "psi_ref [deg]", 0, EXT_IN, 1, 1, 1 },

  { 14, "eta_QTM/y_m", 0, EXT_IN, 1, 1, 1 },

  { 15, "eta_QTM/psi_m", 0, EXT_IN, 1, 1, 1 },

  { 16, "Regulator 2 x/k2_x", 0, EXT_IN, 1, 1, 1 },

  { 17, "Regulator 2 x/reset", 0, EXT_IN, 1, 1, 1 },

  { 18, "Regulator 2 x/k1_x", 0, EXT_IN, 1, 1, 1 },

  { 19, "Regulator 2 x/gamma_x", 0, EXT_IN, 1, 1, 1 },

  { 20, "Regulator 2 x/sigma_x", 0, EXT_IN, 1, 1, 1 },

  { 21, "Regulator 2 x/nu_x", 0, EXT_IN, 1, 1, 1 },

  { 22, "Regulator 2 y/Y_limit", 0, EXT_IN, 1, 1, 1 },

  { 23, "Regulator 2 y/k0_y", 0, EXT_IN, 1, 1, 1 },

  { 24, "Regulator 2 y/k2_y", 0, EXT_IN, 1, 1, 1 },

  { 25, "Regulator 2 y/reset", 0, EXT_IN, 1, 1, 1 },

  { 26, "Regulator 2 y/k1_y", 0, EXT_IN, 1, 1, 1 },

  { 27, "Regulator 2 y/gamma_y", 0, EXT_IN, 1, 1, 1 },

  { 28, "Regulator 2 y/sigma_y", 0, EXT_IN, 1, 1, 1 },

  { 29, "Regulator 2 y/nu_y", 0, EXT_IN, 1, 1, 1 },

  { 30, "Regulator 2 psi/N_limit", 0, EXT_IN, 1, 1, 1 },

  { 31, "Regulator 2 psi/k0_psi", 0, EXT_IN, 1, 1, 1 },

  { 32, "Regulator 2 psi/k2_psi", 0, EXT_IN, 1, 1, 1 },

  { 33, "Regulator 2 psi/reset", 0, EXT_IN, 1, 1, 1 },

  { 34, "Regulator 2 psi/k1_psi", 0, EXT_IN, 1, 1, 1 },

  { 35, "Regulator 2 psi/gamma_psi", 0, EXT_IN, 1, 1, 1 },

  { 36, "Regulator 2 psi/sigma_psi", 0, EXT_IN, 1, 1, 1 },

  { 37, "Regulator 2 psi/nu_psi", 0, EXT_IN, 1, 1, 1 },

  { 38, "current emulator/current velocity", 0, EXT_IN, 1, 1, 1 },

  { 39, "current emulator/current offset max", 0, EXT_IN, 1, 1, 1 },

  { 40, "current emulator/current offset min", 0, EXT_IN, 1, 1, 1 },

  { 41, "IMU/Acc_x", 1, EXT_IN, 1, 1, 1 },

  { 42, "IMU/Acc_y", 1, EXT_IN, 1, 1, 1 },

  { 43, "IMU/Acc_z", 1, EXT_IN, 1, 1, 1 },

  { 44, "IMU/Gyro_x", 1, EXT_IN, 1, 1, 1 },

  { 45, "IMU/Gyro_y", 1, EXT_IN, 1, 1, 1 },

  { 46, "IMU/Gyro_z", 1, EXT_IN, 1, 1, 1 },

  { 1, "Output to Workspace", 1, EXT_OUT, 1, 1, 1 },

  { 2, "x_biased", 0, EXT_OUT, 1, 1, 1 },

  { 3, "x_bias", 0, EXT_OUT, 1, 1, 1 },

  { 4, "Regulator 2 x/X_saturated", 0, EXT_OUT, 1, 1, 1 },

  { 5, "Regulator 2 x/X_unsaturated", 0, EXT_OUT, 1, 1, 1 },

  { 6, "Regulator 2 y/Y_saturated", 0, EXT_OUT, 1, 1, 1 },

  { 7, "Regulator 2 y/Y_unsaturated", 0, EXT_OUT, 1, 1, 1 },

  { 8, "Regulator 2 psi/N_saturated", 0, EXT_OUT, 1, 1, 1 },

  { 9, "Regulator 2 psi/N_unsaturated", 0, EXT_OUT, 1, 1, 1 },

  { 10, "Output/alpha1", 0, EXT_OUT, 1, 1, 1 },

  { 11, "Output/alpha2", 0, EXT_OUT, 1, 1, 1 },

  { 12, "Output/alpha3", 0, EXT_OUT, 1, 1, 1 },

  { 13, "Output/alpha4", 0, EXT_OUT, 1, 1, 1 },

  { 14, "Output/alpha5", 0, EXT_OUT, 1, 1, 1 },

  { 15, "Output/alpha6", 0, EXT_OUT, 1, 1, 1 },

  { 16, "Output/u1", 0, EXT_OUT, 1, 1, 1 },

  { 17, "Output/u2", 0, EXT_OUT, 1, 1, 1 },

  { 18, "Output/u3", 0, EXT_OUT, 1, 1, 1 },

  { 19, "Output/u4", 0, EXT_OUT, 1, 1, 1 },

  { 20, "Output/u5", 0, EXT_OUT, 1, 1, 1 },

  { 21, "Output/u6", 0, EXT_OUT, 1, 1, 1 },

  { 22, "thrust command/X", 0, EXT_OUT, 1, 1, 1 },

  { 23, "thrust command/Y", 0, EXT_OUT, 1, 1, 1 },

  { 24, "thrust command/N", 0, EXT_OUT, 1, 1, 1 },
...
static const char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "ctrl_custom";
static const char* NI_CompiledModelVersion = "1.89";
static const char* NI_CompiledModelDateTime = "Sun Nov 19 18:27:46 2017";
  ...
  * clockTicksNames, int32_t* clockTicks)
{
  ...
  if ((discStates != NULL) && (discStatesNames != NULL)) {
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.x_biased_DWORK1, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.x_biased_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.x_bias_DWORK1, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.x_bias_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.alpha1_rad_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.alpha1_rad_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.alpha2_rad_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.alpha2_rad_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.alpha3_rad_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.alpha3_rad_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.alpha4_rad_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.alpha4_rad_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.alpha5_rad_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.alpha5_rad_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.alpha6_rad_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.alpha6_rad_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.X_limit_DWORK1, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.X_limit_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.X_saturated_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.X_saturated_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_custom_DW.X_unsaturated_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_custom_DW.X_unsaturated_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.Y_limit_DWORK1, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.Y_limit_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.Y_saturated_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.Y_saturated_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_custom_DW.Y_unsaturated_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_custom_DW.Y_unsaturated_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.N_limit_DWORK1, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.N_limit_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.N_saturated_DWORK1,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.N_saturated_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_custom_DW.N_unsaturated_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_custom_DW.N_unsaturated_DWORK1");
    ...
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_custom_DW.currentvelocity_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_custom_DW.currentvelocity_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_custom_DW.currentoffsetmax_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_custom_DW.currentoffsetmax_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
      (&ctrl_custom_DW.currentoffsetmin_DWORK1, 0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100),
           "&ctrl_custom_DW.currentoffsetmin_DWORK1");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.x_biased_DWORK2,
        count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.x_biased_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.x_bias_DWORK2,
        count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.x_bias_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.alpha1_rad_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.alpha1_rad_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.alpha2_rad_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.alpha2_rad_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.alpha3_rad_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.alpha3_rad_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.alpha4_rad_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.alpha4_rad_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.alpha5_rad_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.alpha5_rad_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.alpha6_rad_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.alpha6_rad_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.X_limit_DWORK2,
        count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.X_limit_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.X_saturated_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.X_saturated_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.X_unsaturated_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.X_unsaturated_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.Y_limit_DWORK2,
        count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.Y_limit_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.Y_saturated_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.Y_saturated_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.Y_unsaturated_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.Y_unsaturated_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.N_limit_DWORK2,
        count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.N_limit_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.N_saturated_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.N_saturated_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.N_unsaturated_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.N_unsaturated_DWORK2");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.currentvelocity_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.currentvelocity_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.currentoffsetmax_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.currentoffsetmax_DWORK2");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.currentoffsetmin_DWORK2, count, 19, 0);
      strcpy(discStatesNames + (idx++ * 100),
             "&ctrl_custom_DW.currentoffsetmin_DWORK2");
    }
  ...
  int32_t* clockTicks)
{
  ...
  if (discStates != NULL) {
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.x_m_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.x_biased_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.x_ref_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.x_bias_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.y_ref_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.alpha1_rad_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.alpha2_rad_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.alpha3_rad_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.alpha4_rad_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.alpha5_rad_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.alpha6_rad_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.X_limit_DWORK1, 0, discStates[idx++],
      0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.gamma_x_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.X_saturated_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.sigma_x_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.X_unsaturated_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.nu_x_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.Y_limit_DWORK1, 0, discStates[idx++],
      0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.gamma_y_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.Y_saturated_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.sigma_y_DWORK1, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.Y_unsaturated_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.nu_y_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.N_limit_DWORK1, 0, discStates[idx++],
      0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.gamma_psi_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.N_saturated_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.sigma_psi_DWORK1, 0, discStates[idx
      ++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.N_unsaturated_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.currentvelocity_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.currentoffsetmax_DWORK1, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.currentoffsetmin_DWORK1, 0,
      discStates[idx++], 0, 0);
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.x_biased_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.x_bias_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.alpha1_rad_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.alpha2_rad_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.alpha3_rad_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.alpha4_rad_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.alpha5_rad_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.alpha6_rad_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.X_limit_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.X_saturated_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.X_unsaturated_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.Y_limit_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.Y_saturated_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.Y_unsaturated_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.N_limit_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.N_saturated_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.N_unsaturated_DWORK2, count,
        discStates[idx++], 19, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.currentvelocity_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.currentoffsetmax_DWORK2, count,
        discStates[idx++], 19, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.currentoffsetmin_DWORK2, count,
        discStates[idx++], 19, 0);
    }
