 ...
 *    '<S47>/MATLAB Function4'
 *    '<S47>/MATLAB Function5'
 *    '<S47>/MATLAB Function6'
 */
...
void ctrl_custom_output(void)
{
  ...
  for (i = 0; i < 3; i++) {
    rtb_MatrixMultiply2[i] = rtb_CreateDiagonalMatrix5[i + 6] *
      ctrl_custom_B.TmpSignalConversionAtMatrixMult[2] +
      (rtb_CreateDiagonalMatrix5[i + 3] *
       ctrl_custom_B.TmpSignalConversionAtMatrixMult[1] +
       rtb_CreateDiagonalMatrix5[i] *
   ...
   */
  for (i = 0; i < 3; i++) {
    rtb_MatrixMultiply1[i] = rtb_CreateDiagonalMatrix5[i + 6] *
      ctrl_custom_X.Integrator1_CSTATE[2] + (rtb_CreateDiagonalMatrix5[i + 3] *
      ctrl_custom_X.Integrator1_CSTATE[1] + rtb_CreateDiagonalMatrix5[i] *
   ...
   */
  rtb_Row1 = ctrl_custom_B.Integrator1_a[0] - (cos(rtb_MatrixMultiply4[2]) *
   ...
   */
  for (i = 0; i < 3; i++) {
    ctrl_custom_B.Sum1[i] = ((0.0 - rtb_MatrixMultiply2[i]) -
      rtb_MatrixMultiply1[i]) - ((rtb_CreateDiagonalMatrix5[i + 3] * rtb_Row2 +
      rtb_CreateDiagonalMatrix5[i] * rtb_Row1) + rtb_CreateDiagonalMatrix5[i + 6]
      * rtb_Row1_d);
  }
  ...
  for (i = 0; i < 3; i++) {
    ...
    rtb_psi_dot = ctrl_custom_B.CreateDiagonalMatrix2[i + 6] *
      rtb_MatrixMultiply2[2] + (ctrl_custom_B.CreateDiagonalMatrix2[i + 3] *
      rtb_MatrixMultiply2[1] + ctrl_custom_B.CreateDiagonalMatrix2[i] *
  ...
  U_singular[0] = (0.0 * fabs(ctrl_custom_B.Integrator1_a[0]) + -2.332) +
    ctrl_custom_B.Integrator1_a[0] * ctrl_custom_B.Integrator1_a[0] * -8.557;
  U_singular[3] = 0.0;
  U_singular[6] = 0.0;
  U_singular[1] = 0.0;
  U_singular[4] = (0.3976 * fabs(ctrl_custom_B.Integrator1_a[1]) + -4.673) +
    ctrl_custom_B.Integrator1_a[1] * ctrl_custom_B.Integrator1_a[1] * -313.3;
  U_singular[7] = 0.0;
  U_singular[2] = 0.0;
  U_singular[5] = 0.0;
  U_singular[8] = (-0.01148 * fabs(ctrl_custom_B.Integrator1_a[2]) + -0.01675) +
  ...
  for (i = 0; i < 3; i++) {
     ...
     *  Sum: '<S4>/Sum2'
     */
    tmp_2[i] = (((tmp_0[i] + ctrl_custom_B.Sum1[i]) + tmp_1[i]) -
                ((rtb_CreateDiagonalMatrix5[i + 3] *
                  ctrl_custom_B.Integrator1_a[1] + rtb_CreateDiagonalMatrix5[i] *
                  ctrl_custom_B.Integrator1_a[0]) + rtb_CreateDiagonalMatrix5[i
                 + 6] * ctrl_custom_B.Integrator1_a[2])) - (S_singular_cross[i +
      6] * ctrl_custom_B.Integrator1_a[2] + (S_singular_cross[i + 3] *
      ctrl_custom_B.Integrator1_a[1] + S_singular_cross[i] *
  ...
  for (i = 0; i < 6; i++) {
    ...
    rtb_y[i] = rt_remd_snf(rtb_Row2 * 3.1415926535897931 +
      rtb_TmpSignalConversionAtSFun_i[i], 6.2831853071795862);
  ...
  for (i = 0; i < 6; i++) {
    /* MATLAB Function: '<S9>/angle between  [-180 180]' */
    rtb_Row2 = fabs(rt_remd_snf(alpha[i], 6.2831853071795862) /
                    6.2831853071795862);
    if (rtb_Row2 > 0.0) {
      rtb_Row2 = 1.0;
    } else {
     ...
     *  MATLAB Function: '<S9>/angle between  [-180 180]'
     */
    rtb_TmpSignalConversionAtSFun_n[i + 3] = ctrl_custom_P.Gain_Gain_i *
      (rtb_y[i] - rtb_Row2 * 3.1415926535897931);
  }
  ...
  /* '<S39>:1:14' */
  /* '<S39>:1:15' */
  if (((rtb_TmpSignalConversionAtSFun_n[3] < ctrl_custom_P.C[0] - 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[3] > ctrl_custom_P.C[6] + 0.1)) ||
      ((rtb_TmpSignalConversionAtSFun_n[3] > ctrl_custom_P.C[12] + 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[3] < ctrl_custom_P.C[18] - 0.1))) {
    /* '<S39>:1:21' */
    /* '<S39>:1:22' */
    K[0] = 0.0;
  } else {
  ...
  if (((rtb_TmpSignalConversionAtSFun_n[4] > ctrl_custom_P.C[1] - 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[4] < ctrl_custom_P.C[7] + 0.1)) ||
      ((rtb_TmpSignalConversionAtSFun_n[4] > ctrl_custom_P.C[13] - 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[4] < ctrl_custom_P.C[19] + 0.1))) {
    /* '<S39>:1:27' */
    /* '<S39>:1:28' */
    K[1] = 0.0;
  } else {
  ...
  if (((rtb_TmpSignalConversionAtSFun_n[5] < ctrl_custom_P.C[2] + 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[5] > ctrl_custom_P.C[8] - 0.1)) ||
      ((rtb_TmpSignalConversionAtSFun_n[5] < ctrl_custom_P.C[14] + 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[5] > ctrl_custom_P.C[20] - 0.1))) {
    /* '<S39>:1:33' */
    /* '<S39>:1:34' */
    K[2] = 0.0;
  } else {
  ...
  if (((rtb_TmpSignalConversionAtSFun_n[6] > ctrl_custom_P.C[3] + 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[6] < ctrl_custom_P.C[9] - 0.1)) ||
      ((rtb_TmpSignalConversionAtSFun_n[6] < ctrl_custom_P.C[15] - 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[6] > ctrl_custom_P.C[21] + 0.1))) {
    /* '<S39>:1:39' */
    /* '<S39>:1:40' */
    K[3] = 0.0;
  } else {
  ...
  if (((rtb_TmpSignalConversionAtSFun_n[7] < ctrl_custom_P.C[4] - 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[7] > ctrl_custom_P.C[10] + 0.1)) ||
      ((rtb_TmpSignalConversionAtSFun_n[7] < ctrl_custom_P.C[16] - 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[7] > ctrl_custom_P.C[22] + 0.1))) {
    /* '<S39>:1:45' */
    /* '<S39>:1:46' */
    K[4] = 0.0;
  } else {
  ...
  if (((rtb_TmpSignalConversionAtSFun_n[8] > ctrl_custom_P.C[5] + 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[8] < ctrl_custom_P.C[11] - 0.1)) ||
      ((rtb_TmpSignalConversionAtSFun_n[8] > ctrl_custom_P.C[17] + 0.1) &&
       (rtb_TmpSignalConversionAtSFun_n[8] < ctrl_custom_P.C[23] - 0.1))) {
    /* '<S39>:1:51' */
    /* '<S39>:1:52' */
    K[5] = 0.0;
  } else {
  ...
  for (i = 0; i < 6; i++) {
    ...
    /* '<S39>:1:65' */
    rtb_y[i] = alpha[i];
    ctrl_custom_cosd(&rtb_y[i]);

    /* Thrust in x-direction for cartesian */
    /* '<S39>:1:66' */
    s[i] = alpha[i];
    ctrl_custom_sind(&s[i]);
    ...
    rtb_TmpSignalConversionAtSFun_i[i] = rtb_Row2 *
      ctrl_custom_P.XpositionThruster_Value[i] - rtb_Row1_d *
      ctrl_custom_P.YpositionThruster_Value[i];
  }
  ...
  for (i = 0; i < 6; i++) {
    for (b_i = 0; b_i < 3; b_i++) {
      ...
      for (b_sizes = 0; b_sizes < 6; b_sizes++) {
        rtb_y_0[b_i + 3 * i] += rtb_y_1[3 * b_sizes + b_i] * b_V_singular[6 * i
          + b_sizes];
      }
    }
  }

  ctrl_custom_svd(rtb_y_0, U_singular, S_singular_cross, rtb_y_1);
  ...
  ctrl_custom_svd_hb(d_0, U_singular, S_singular_cross, b_V_singular);
  ...
  for (i = 0; i < 6; i++) {
    if (ctrl_custom_B.Angle_controller >=
      ...
      ctrl_custom_B.ChoosingFixedAzimuthangle[i] =
        ctrl_custom_P.constantangle_Value[i];
    }
  }
  ...
  for (ForEach_itr = 0; ForEach_itr < 6; ForEach_itr++) {
    ...
    if (rtmIsMajorTimeStep(ctrl_custom_M)) {
      ...
      /* Gain: '<S43>/Gain1' */
      lambda_c = ctrl_custom_P.CoreSubsys.Gain1_Gain *
        ctrl_custom_B.CoreSubsys[ForEach_itr].angle;
      ...
      /*  s = sign(angle); */
      /* '<S44>:1:43' */
      rtb_Row2 = fabs(rt_remd_snf(lambda_c + 3.1415926535897931,
      ...
      lambda_c = rt_remd_snf(rtb_Row1_d * 3.1415926535897931 + lambda_c,
        6.2831853071795862) - rtb_Row2 * 3.1415926535897931;
  ...
  /* '<S64>:1:3' */
  lambda_c = tanh(ctrl_custom_P.eps_c * ctrl_custom_X.Integrator_CSTATE_a / 5.0)
    * 0.5 + 0.5;
  ...
  rtb_Row2 = ((1.0 - lambda_c) * ctrl_custom_P.K_q1r + ctrl_custom_P.K_q1f *
              lambda_c) * rtb_Row2 * ctrl_custom_P.Rho * rt_powd_snf
   ...
   */
  ctrl_custom_B.output[0] = ((1.0 - lambda_c) * ctrl_custom_P.K_T1r +
    ctrl_custom_P.K_T1f * lambda_c) * rtb_Row2 * ctrl_custom_P.Rho * rt_powd_snf
    (ctrl_custom_P.D, 4.0) * (ctrl_custom_X.Integrator_CSTATE_a *
    ctrl_custom_X.Integrator_CSTATE_a) - ctrl_custom_P.Lossesplaceholder_Value;
  ...
  for (i = 0; i < 5; i++) {
    rtb_positivethrust2 = rtb_positivethrust2 * lambda_c +
      ctrl_custom_P.pwm_thr2_forward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_negativethrust2 = rtb_negativethrust2 * lambda_c +
      ctrl_custom_P.pwm_thr2_backward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_positivethrust3 = rtb_positivethrust3 * lambda_c +
      ctrl_custom_P.pwm_thr3_forward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_negativethrust3 = rtb_negativethrust3 * lambda_c +
      ctrl_custom_P.pwm_thr3_backward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_positivethrust4 = rtb_positivethrust4 * lambda_c +
      ctrl_custom_P.pwm_thr4_forward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_negativethrust4 = rtb_negativethrust4 * lambda_c +
      ctrl_custom_P.pwm_thr4_backward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_positivethrust5 = rtb_positivethrust5 * lambda_c +
      ctrl_custom_P.pwm_thr5_forward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_negativethrust5 = rtb_negativethrust5 * lambda_c +
      ctrl_custom_P.pwm_thr5_backward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_positivethrust6 = rtb_positivethrust6 * lambda_c +
      ctrl_custom_P.pwm_thr6_forward[i + 1];
  }
  ...
  for (i = 0; i < 5; i++) {
    rtb_negativethrust6 = rtb_negativethrust6 * lambda_c +
      ctrl_custom_P.pwm_thr6_backward[i + 1];
  }
   ...
   *  Fcn: '<S4>/Fcn'
   */
  lambda_c_0[0] = cos(rtb_Row1) * ctrl_custom_B.Integrator1_a[0] - sin(rtb_Row1)
    * ctrl_custom_B.Integrator1_a[1];
  lambda_c_0[1] = sin(rtb_Row1) * ctrl_custom_B.Integrator1_a[0] + cos(rtb_Row1)
    * ctrl_custom_B.Integrator1_a[1];
  lambda_c_0[2] = ctrl_custom_B.Integrator1_a[2];
  for (i = 0; i < 3; i++) {
    /* Product: '<S4>/Matrix Multiply1' */
    ctrl_custom_B.MatrixMultiply1[i] = 0.0;
    ctrl_custom_B.MatrixMultiply1[i] += ctrl_custom_B.CreateDiagonalMatrix1[i] *
      rtb_MatrixMultiply2[0];
    ctrl_custom_B.MatrixMultiply1[i] += ctrl_custom_B.CreateDiagonalMatrix1[i +
      3] * rtb_MatrixMultiply2[1];
    ctrl_custom_B.MatrixMultiply1[i] += ctrl_custom_B.CreateDiagonalMatrix1[i +
      6] * rtb_MatrixMultiply2[2];

    /* Sum: '<S4>/Sum1' incorporates:
     *  Product: '<S4>/Matrix Multiply'
     */
    ctrl_custom_B.Sum1_g[i] = (ctrl_custom_B.CreateDiagonalMatrix[i + 6] *
      rtb_MatrixMultiply2[2] + (ctrl_custom_B.CreateDiagonalMatrix[i + 3] *
      rtb_MatrixMultiply2[1] + ctrl_custom_B.CreateDiagonalMatrix[i] *
      rtb_MatrixMultiply2[0])) + lambda_c_0[i];
  }
  ...
  for (i = 0; i < 3; i++) {
     ...
     */
    ctrl_custom_B.Sum_m[i] = (rtb_CreateDiagonalMatrix5[i + 6] *
      ctrl_custom_B.psi_ref + (rtb_CreateDiagonalMatrix5[i + 3] *
      ctrl_custom_B.y_ref + rtb_CreateDiagonalMatrix5[i] * ctrl_custom_B.x_ref))
      - (rtb_CreateDiagonalMatrix5[i + 6] * ctrl_custom_X.Integrator_CSTATE_f5[2]
         + (rtb_CreateDiagonalMatrix5[i + 3] *
            ctrl_custom_X.Integrator_CSTATE_f5[1] + rtb_CreateDiagonalMatrix5[i]
    ...
    for (b_i = 0; b_i < 3; b_i++) {
      ...
      U_singular[i + 3 * b_i] += rtb_CreateDiagonalMatrix3[3 * b_i] *
        rtb_CreateDiagonalMatrix3[i];
      U_singular[i + 3 * b_i] += rtb_CreateDiagonalMatrix3[3 * b_i + 1] *
        rtb_CreateDiagonalMatrix3[i + 3];
      U_singular[i + 3 * b_i] += rtb_CreateDiagonalMatrix3[3 * b_i + 2] *
        rtb_CreateDiagonalMatrix3[i + 6];
       ...
       *  Sum: '<S8>/Sum1'
       */
      tmp_0[i] += ctrl_custom_B.sf_MATLABFunction_b.y[3 * b_i + i] *
        ctrl_custom_X.Integrator_CSTATE_f5[b_i];

      /* Product: '<S8>/Matrix Multiply3' incorporates:
       *  Sum: '<S8>/Sum1'
       */
      tmp_1[i] += ctrl_custom_B.sf_MATLABFunction1_k.y[3 * b_i + i] *
  ...
  rtb_psi_dot = sqrt(fabs(rtb_sys[6]) / (ctrl_custom_P.Rho * rt_powd_snf
  ...
  rtb_T_r_p = ((1.0 - lambda_c) * ctrl_custom_P.K_T1r + ctrl_custom_P.K_T1f *
               lambda_c) * rtb_Row2 * ctrl_custom_P.Rho * rt_powd_snf
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_Supervisor(ctrl_custom_B.Memory, 0.0, ctrl_custom_B.Delay[0],
      &ctrl_custom_B.sf_Supervisor);
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_Supervisor(ctrl_custom_B.Memory_l, 0.0, ctrl_custom_B.Delay[1],
  ...
  rtb_psi_dot = sqrt(fabs(rtb_sys[8]) / (ctrl_custom_P.Rho * rt_powd_snf
  ...
  rtb_T_r_e = ((1.0 - lambda_c) * ctrl_custom_P.K_T3f + ctrl_custom_P.K_T3f *
               lambda_c) * rtb_Row2 * ctrl_custom_P.Rho * rt_powd_snf
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_Supervisor(ctrl_custom_B.Memory_ln, 0.0, ctrl_custom_B.Delay[2],
  ...
  ctrl_custom_MATLABFunction_a(rtb_sys[9], ctrl_custom_P.K_T4f,
    ...
    ctrl_custom_B.Delay_m, &ctrl_custom_B.sf_MATLABFunction_dv);
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_DW.DiscreteTransferFcn_tmp_l =
      (ctrl_custom_B.sf_MATLABFunction_dv.n_d - ctrl_custom_P.Constant2_Value_h
       [1] * ctrl_custom_DW.DiscreteTransferFcn_states_e[0]) -
  ...
  CorecontrollerTorquePowerandCom(ctrl_custom_P.k_cc, ctrl_custom_P.p_cc,
    ...
    ctrl_custom_P.K_q4f, ctrl_custom_P.D, ctrl_custom_B.sf_MATLABFunction_dv.T_r,
  ...
  ctrl_custom_B.Sum_a = (ctrl_custom_B.Inertiacompensation_bn +
    ctrl_custom_B.Sum1_cp) + lambda_c;
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_Supervisor(ctrl_custom_B.Memory_j, 0.0, ctrl_custom_B.Delay[3],
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_Supervisor(ctrl_custom_B.Memory_d, 0.0, ctrl_custom_B.Delay[4],
  ...
  rtb_psi_dot = sqrt(fabs(rtb_sys[11]) / (ctrl_custom_P.Rho * rt_powd_snf
  ...
  rtb_T_r = ((1.0 - lambda_c) * ctrl_custom_P.K_T6r + ctrl_custom_P.K_T6f *
             lambda_c) * rtb_Row2 * ctrl_custom_P.Rho * rt_powd_snf
  ...
  if (rtmIsMajorTimeStep(ctrl_custom_M)) {
    ...
    ctrl_custom_Supervisor(ctrl_custom_B.Memory_o, 0.0, ctrl_custom_B.Delay[5],
...
void ctrl_custom_initialize(void)
{
...

  {
    ...
    /* InitializeConditions for DiscreteTransferFcn: '<S49>/Discrete Transfer Fcn' */
    ctrl_custom_DW.DiscreteTransferFcn_states_j0 =
...
RT_MODEL_ctrl_custom_T *ctrl_custom(void)
{
  ...
  ctrl_custom_M->Sizes.numBlocks = (573);/* Number of blocks */
  ctrl_custom_M->Sizes.numBlockIO = (218);/* Number of block outputs */
  ctrl_custom_M->Sizes.numBlockPrms = (965);/* Sum of parameter "widths" */
...
void SetExternalInputs(double* data, int_T* TaskSampleHit)
{
  ...
  // ctrl_custom/Thrust allocation/reset
  if (TaskSampleHit[1]) {
    for (count = 0; count < 6; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_B.reset, count, data[index++], 25, 0);
    }
  } else {
    index += 6;
  }
  ...
  // ctrl_custom/Thruster control /Thruster 1/Shaft dynamics/reset
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.reset_c, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Thruster control /Thruster 2/Shaft dynamics/reset
  if (TaskSampleHit[0]) {
  ...
  // ctrl_custom/Thruster control /Thruster 3/Shaft dynamics/reset
  if (TaskSampleHit[0]) {
  ...
  // ctrl_custom/Thruster control /Thruster 4/Shaft dynamics/reset
  if (TaskSampleHit[0]) {
  ...
  // ctrl_custom/Thruster control /Thruster 5/Shaft dynamics/reset
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.reset_nr, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }

  // ctrl_custom/Thruster control /Thruster 6/Shaft dynamics/reset
  if (TaskSampleHit[0]) {
  ...
  // ctrl_custom/Referance1/psi_ref
  if (TaskSampleHit[0]) {
  ...
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.reset_p, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.reset_l2, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.reset_i0, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
  ...
  if (TaskSampleHit[0]) {
    NIRT_SetValueByDataType(&ctrl_custom_B.reset_ep, 0, data[index++], 0, 0);
  } else {
    index += 1;
  }
...
void SetExternalOutputs(double* data, int_T* TaskSampleHit)
{
  ...
  // ctrl_custom/PID controller1/y_error: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
  ...
  // ctrl_custom/PID controller1/psi_error: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_custom_B.regulationerror,
      2, 22, 0);
  } else {
  ...
  // ctrl_custom/PID controller1/x_error: Virtual Signal # 0
  if (TaskSampleHit[0]) {              // sample and hold
    ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_custom_B.regulationerror,
      0, 22, 0);
  } else {
...
int32_t NI_InitExternalOutputs()
{
  ...
  // ctrl_custom/PID controller1/psi_error: Virtual Signal # 0
  ni_extout[index++] = NIRT_GetValueByDataType(&ctrl_custom_B.regulationerror, 2,
    22, 0);
...
static NI_Parameter NI_ParamList[] DataSection(".NIVS.paramlist") =
{
  ...
  { 70,
    ...
    offsetof(P_ctrl_custom_T, Min_thrust), 62, 1, 2, 140, 0 },

  { 71,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 13/LowerLimit",
    offsetof(P_ctrl_custom_T, Min_thrust), 62, 1, 2, 142, 0 },
  ...
  { 76, "ctrl_custom/Thruster control /Thruster 1/Thruster control/Qf_0/Gain",
    offsetof(P_ctrl_custom_T, Q_f0), 62, 1, 2, 152, 0 },

  { 77, "ctrl_custom/Thruster control /Thruster 2/Thruster control/Qf_0/Gain",
    offsetof(P_ctrl_custom_T, Q_f0), 62, 1, 2, 154, 0 },

  { 78, "ctrl_custom/Thruster control /Thruster 3/Thruster control/Qf_0/Gain",
    offsetof(P_ctrl_custom_T, Q_f0), 62, 1, 2, 156, 0 },

  { 79, "ctrl_custom/Thruster control /Thruster 4/Thruster control/Qf_0/Gain",
    offsetof(P_ctrl_custom_T, Q_f0), 62, 1, 2, 158, 0 },

  { 80, "ctrl_custom/Thruster control /Thruster 5/Thruster control/Qf_0/Gain",
    offsetof(P_ctrl_custom_T, Q_f0), 62, 1, 2, 160, 0 },

  { 81, "ctrl_custom/Thruster control /Thruster 6/Thruster control/Qf_0/Gain",
    offsetof(P_ctrl_custom_T, Q_f0), 62, 1, 2, 162, 0 },

  { 82, "ctrl_custom/Thruster Parameters /Rho/Value", offsetof(P_ctrl_custom_T,
    Rho), 62, 1, 2, 164, 0 },

  { 83, "ctrl_custom/Thrust allocation/Constant to avoid singularities/Value",
    offsetof(P_ctrl_custom_T, eps), 62, 1, 2, 166, 0 },

  { 84, "ctrl_custom/Thruster Parameters /Constant/Value", offsetof
    (P_ctrl_custom_T, eps_c), 62, 1, 2, 168, 0 },

  { 85,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Qff_0(nr)/Gain/epsilon",
    offsetof(P_ctrl_custom_T, epsilon), 62, 1, 2, 170, 0 },

  { 86,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Qff_0(nr)/Gain/n_max",
    offsetof(P_ctrl_custom_T, n_max), 62, 1, 2, 172, 0 },
  ...
  { 97, "ctrl_custom/Thruster Parameters /Constant1/Value", offsetof
    (P_ctrl_custom_T, k_cc), 62, 1, 2, 194, 0 },

  { 98, "ctrl_custom/Thruster Parameters /Constant5/Value", offsetof
    (P_ctrl_custom_T, n_c), 62, 1, 2, 196, 0 },

  { 99, "ctrl_custom/Thruster Parameters /Constant2/Value", offsetof
    (P_ctrl_custom_T, p_cc), 62, 1, 2, 198, 0 },

  { 100,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/negative thrust 1/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr1_backward), 35, 6, 2, 200, 0 },

  { 101,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/positive thrust 1/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr1_forward), 35, 6, 2, 202, 0 },

  { 102,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/negative thrust 2/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr2_backward), 35, 6, 2, 204, 0 },

  { 103,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/positive thrust 2/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr2_forward), 35, 6, 2, 206, 0 },

  { 104,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/negative thrust 3/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr3_backward), 35, 6, 2, 208, 0 },

  { 105,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/positive thrust 3/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr3_forward), 35, 6, 2, 210, 0 },

  { 106,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/negative thrust 4/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr4_backward), 35, 6, 2, 212, 0 },

  { 107,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/positive thrust 4/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr4_forward), 35, 6, 2, 214, 0 },

  { 108,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/negative thrust 5/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr5_backward), 35, 6, 2, 216, 0 },

  { 109,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/positive thrust 5/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr5_forward), 35, 6, 2, 218, 0 },

  { 110,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/negative thrust 6/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr6_backward), 35, 6, 2, 220, 0 },

  { 111,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/positive thrust 6/Coefs",
    offsetof(P_ctrl_custom_T, pwm_thr6_forward), 35, 6, 2, 222, 0 },

  { 112, "ctrl_custom/Thruster Parameters /Constant3/Value", offsetof
    (P_ctrl_custom_T, r_cc), 62, 1, 2, 224, 0 },

  { 113, "ctrl_custom/Pose/Gain/Gain", offsetof(P_ctrl_custom_T, Gain_Gain), 62,
    1, 2, 226, 0 },

  { 114, "ctrl_custom/Pose/Gain1/Gain", offsetof(P_ctrl_custom_T, Gain1_Gain),
    62, 1, 2, 228, 0 },

  { 115, "ctrl_custom/Pose/Gain5/Gain", offsetof(P_ctrl_custom_T, Gain5_Gain),
    62, 1, 2, 230, 0 },

  { 116, "ctrl_custom/Pose/Saturation/UpperLimit", offsetof(P_ctrl_custom_T,
    Saturation_UpperSat), 62, 1, 2, 232, 0 },

  { 117, "ctrl_custom/Pose/Saturation/LowerLimit", offsetof(P_ctrl_custom_T,
    Saturation_LowerSat), 62, 1, 2, 234, 0 },

  { 118, "ctrl_custom/Pose/Gain6/Gain", offsetof(P_ctrl_custom_T, Gain6_Gain),
    62, 1, 2, 236, 0 },

  { 119, "ctrl_custom/Pose/Constant1/Value", offsetof(P_ctrl_custom_T,
    Constant1_Value), 62, 1, 2, 238, 0 },

  { 120,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]/Saturation/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation_UpperSat_p), 62, 1, 2, 240, 0 },

  { 121,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]/Saturation/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation_LowerSat_k), 62, 1, 2, 242, 0 },

  { 122,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]/Gain/Gain",
    offsetof(P_ctrl_custom_T, Gain_Gain_p), 62, 1, 2, 244, 0 },

  { 123,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]/Constant/Value",
    offsetof(P_ctrl_custom_T, Constant_Value), 62, 1, 2, 246, 0 },

  { 124,
    "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]1/Saturation/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation_UpperSat_i), 62, 1, 2, 248, 0 },

  { 125,
    "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]1/Saturation/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation_LowerSat_p), 62, 1, 2, 250, 0 },

  { 126, "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]1/Gain/Gain",
    offsetof(P_ctrl_custom_T, Gain_Gain_o), 62, 1, 2, 252, 0 },

  { 127, "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]1/Constant/Value",
    offsetof(P_ctrl_custom_T, Constant_Value_p), 62, 1, 2, 254, 0 },

  { 128, "ctrl_custom/Referance1/Integrator2/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator2_IC), 62, 1, 2, 256, 0 },

  { 129, "ctrl_custom/Referance1/[-inf inf] to [-pi pi]/Saturation/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation_UpperSat_p4), 62, 1, 2, 258, 0 },

  { 130, "ctrl_custom/Referance1/[-inf inf] to [-pi pi]/Saturation/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation_LowerSat_c), 62, 1, 2, 260, 0 },

  { 131, "ctrl_custom/Referance1/[-inf inf] to [-pi pi]/Gain/Gain", offsetof
    (P_ctrl_custom_T, Gain_Gain_e), 62, 1, 2, 262, 0 },

  { 132, "ctrl_custom/Referance1/[-inf inf] to [-pi pi]/Constant/Value",
    offsetof(P_ctrl_custom_T, Constant_Value_e), 62, 1, 2, 264, 0 },

  { 133,
    "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]/Saturation/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation_UpperSat_ir), 62, 1, 2, 266, 0 },

  { 134,
    "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]/Saturation/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation_LowerSat_l), 62, 1, 2, 268, 0 },

  { 135, "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]/Gain/Gain",
    offsetof(P_ctrl_custom_T, Gain_Gain_d), 62, 1, 2, 270, 0 },

  { 136, "ctrl_custom/PID controller1/[-inf inf] to [-pi pi]/Constant/Value",
    offsetof(P_ctrl_custom_T, Constant_Value_a), 62, 1, 2, 272, 0 },

  { 137, "ctrl_custom/PID controller1/Integrator1/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator1_IC), 62, 1, 2, 274, 0 },

  { 138, "ctrl_custom/Referance1/Integrator1/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator1_IC_b), 62, 1, 2, 276, 0 },

  { 139, "ctrl_custom/Nonlinear Passisve Observer/Integrator1/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator1_IC_g), 36, 3, 2, 278, 0 },

  { 140, "ctrl_custom/Gain5/Gain", offsetof(P_ctrl_custom_T, Gain5_Gain_e), 62,
    1, 2, 280, 0 },

  { 141, "ctrl_custom/Gain/Gain", offsetof(P_ctrl_custom_T, Gain_Gain_g), 62, 1,
    2, 282, 0 },

  { 142,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]1/Saturation/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation_UpperSat_j), 62, 1, 2, 284, 0 },

  { 143,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]1/Saturation/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation_LowerSat_f), 62, 1, 2, 286, 0 },

  { 144,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]1/Gain/Gain",
    offsetof(P_ctrl_custom_T, Gain_Gain_gg), 62, 1, 2, 288, 0 },

  { 145,
    "ctrl_custom/Nonlinear Passisve Observer/[-inf inf] to [-pi pi]1/Constant/Value",
    offsetof(P_ctrl_custom_T, Constant_Value_i), 62, 1, 2, 290, 0 },

  { 146, "ctrl_custom/Nonlinear Passisve Observer/Integrator2/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator2_IC_i), 36, 3, 2, 292, 0 },

  { 147,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant6/Value",
    offsetof(P_ctrl_custom_T, Constant6_Value), 62, 1, 2, 294, 0 },

  { 148,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant7/Value",
    offsetof(P_ctrl_custom_T, Constant7_Value), 62, 1, 2, 296, 0 },

  { 149,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant8/Value",
    offsetof(P_ctrl_custom_T, Constant8_Value), 62, 1, 2, 298, 0 },

  { 150, "ctrl_custom/Nonlinear Passisve Observer/M^-1/Gain", offsetof
    (P_ctrl_custom_T, M1_Gain), 24, 9, 2, 300, 0 },

  { 151, "ctrl_custom/Thrust allocation/Radians to Degrees/Gain/Gain", offsetof
    (P_ctrl_custom_T, Gain_Gain_i), 62, 1, 2, 302, 0 },

  { 152, "ctrl_custom/Thrust allocation/X-position Thruster/Value", offsetof
    (P_ctrl_custom_T, XpositionThruster_Value[0]), 35, 6, 2, 304, 0 },

  { 153, "ctrl_custom/Thrust allocation/Y-position Thruster/Value", offsetof
    (P_ctrl_custom_T, YpositionThruster_Value[0]), 35, 6, 2, 306, 0 },

  { 154, "ctrl_custom/Thrust allocation/constant angle/Value", offsetof
    (P_ctrl_custom_T, constantangle_Value[0]), 35, 6, 2, 308, 0 },

  { 155,
    "ctrl_custom/Thrust allocation/Choosing Fixed // Azimuth angle/Threshold",
    offsetof(P_ctrl_custom_T, ChoosingFixedAzimuthangle_Thres), 62, 1, 2, 310, 0
  },

  { 156, "ctrl_custom/Thruster control /Subsystem1/Saturation 1/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation1_UpperSat), 62, 1, 2, 312, 0 },

  { 157, "ctrl_custom/Thruster control /Subsystem1/Saturation 1/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation1_LowerSat), 62, 1, 2, 314, 0 },

  { 158, "ctrl_custom/Thruster control /Subsystem1/Saturation 2/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation2_UpperSat), 62, 1, 2, 316, 0 },

  { 159, "ctrl_custom/Thruster control /Subsystem1/Saturation 2/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation2_LowerSat), 62, 1, 2, 318, 0 },

  { 160, "ctrl_custom/Thruster control /Subsystem1/Saturation 3/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation3_UpperSat), 62, 1, 2, 320, 0 },

  { 161, "ctrl_custom/Thruster control /Subsystem1/Saturation 3/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation3_LowerSat), 62, 1, 2, 322, 0 },

  { 162, "ctrl_custom/Thruster control /Subsystem1/Saturation 4/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation4_UpperSat), 62, 1, 2, 324, 0 },

  { 163, "ctrl_custom/Thruster control /Subsystem1/Saturation 4/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation4_LowerSat), 62, 1, 2, 326, 0 },

  { 164, "ctrl_custom/Thruster control /Subsystem1/Saturation 5/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation5_UpperSat), 62, 1, 2, 328, 0 },

  { 165, "ctrl_custom/Thruster control /Subsystem1/Saturation 5/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation5_LowerSat), 62, 1, 2, 330, 0 },

  { 166, "ctrl_custom/Thruster control /Subsystem1/Saturation 6/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation6_UpperSat), 62, 1, 2, 332, 0 },

  { 167, "ctrl_custom/Thruster control /Subsystem1/Saturation 6/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation6_LowerSat), 62, 1, 2, 334, 0 },

  { 168,
    "ctrl_custom/Thruster control /Thruster 1/Shaft dynamics/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC), 62, 1, 2, 336, 0 },

  { 169, "ctrl_custom/Thruster control /Thruster 1/Losses (placeholder)/Value",
    offsetof(P_ctrl_custom_T, Lossesplaceholder_Value), 62, 1, 2, 338, 0 },

  { 170,
    "ctrl_custom/Thruster control /Thruster 2/Shaft dynamics/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_h), 62, 1, 2, 340, 0 },

  { 171, "ctrl_custom/Thruster control /Thruster 2/Losses (placeholder)/Value",
    offsetof(P_ctrl_custom_T, Lossesplaceholder_Value_e), 62, 1, 2, 342, 0 },

  { 172,
    "ctrl_custom/Thruster control /Thruster 3/Shaft dynamics/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_o), 62, 1, 2, 344, 0 },

  { 173, "ctrl_custom/Thruster control /Thruster 3/Losses (placeholder)/Value",
    offsetof(P_ctrl_custom_T, Lossesplaceholder_Value_d), 62, 1, 2, 346, 0 },

  { 174,
    "ctrl_custom/Thruster control /Thruster 4/Shaft dynamics/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_hz), 62, 1, 2, 348, 0 },

  { 175, "ctrl_custom/Thruster control /Thruster 4/Losses (placeholder)/Value",
    offsetof(P_ctrl_custom_T, Lossesplaceholder_Value_n), 62, 1, 2, 350, 0 },

  { 176,
    "ctrl_custom/Thruster control /Thruster 5/Shaft dynamics/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_d), 62, 1, 2, 352, 0 },

  { 177, "ctrl_custom/Thruster control /Thruster 5/Losses (placeholder)/Value",
    offsetof(P_ctrl_custom_T, Lossesplaceholder_Value_k), 62, 1, 2, 354, 0 },

  { 178,
    "ctrl_custom/Thruster control /Thruster 6/Shaft dynamics/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_b), 62, 1, 2, 356, 0 },

  { 179, "ctrl_custom/Thruster control /Thruster 6/Losses (placeholder)/Value",
    offsetof(P_ctrl_custom_T, Lossesplaceholder_Value_nh), 62, 1, 2, 358, 0 },

  { 180,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Gain/Gain",
    offsetof(P_ctrl_custom_T, Gain_Gain_a), 62, 1, 2, 360, 0 },

  { 181,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Gain1/Gain",
    offsetof(P_ctrl_custom_T, Gain1_Gain_i), 62, 1, 2, 362, 0 },

  { 182,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Gain2/Gain",
    offsetof(P_ctrl_custom_T, Gain2_Gain), 62, 1, 2, 364, 0 },

  { 183,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Gain3/Gain",
    offsetof(P_ctrl_custom_T, Gain3_Gain), 62, 1, 2, 366, 0 },

  { 184,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Gain4/Gain",
    offsetof(P_ctrl_custom_T, Gain4_Gain), 62, 1, 2, 368, 0 },

  { 185,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Gain5/Gain",
    offsetof(P_ctrl_custom_T, Gain5_Gain_f), 62, 1, 2, 370, 0 },

  { 186,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 1/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation1_LowerSat_p), 62, 1, 2, 372, 0 },

  { 187,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 2/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation2_UpperSat_j), 62, 1, 2, 374, 0 },

  { 188,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 8/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation8_LowerSat), 62, 1, 2, 376, 0 },

  { 189,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 9/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation9_UpperSat), 62, 1, 2, 378, 0 },

  { 190,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 10/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation10_LowerSat), 62, 1, 2, 380, 0 },

  { 191,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 11/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation11_UpperSat), 62, 1, 2, 382, 0 },

  { 192,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 3/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation3_LowerSat_m), 62, 1, 2, 384, 0 },

  { 193,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 4/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation4_UpperSat_l), 62, 1, 2, 386, 0 },

  { 194,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 5/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation5_LowerSat_j), 62, 1, 2, 388, 0 },

  { 195,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 6/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation6_UpperSat_c), 62, 1, 2, 390, 0 },

  { 196,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 12/LowerLimit",
    offsetof(P_ctrl_custom_T, Saturation12_LowerSat), 62, 1, 2, 392, 0 },

  { 197,
    "ctrl_custom/Thruster control /Thrust and Shaft speed mapped to PWM/Saturation 13/UpperLimit",
    offsetof(P_ctrl_custom_T, Saturation13_UpperSat), 62, 1, 2, 394, 0 },

  { 198, "ctrl_custom/Gain1/Gain", offsetof(P_ctrl_custom_T, Gain1_Gain_l), 62,
    1, 2, 396, 0 },

  { 199,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant/Value",
    offsetof(P_ctrl_custom_T, Constant_Value_g), 62, 1, 2, 398, 0 },

  { 200,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant1/Value",
    offsetof(P_ctrl_custom_T, Constant1_Value_o), 62, 1, 2, 400, 0 },

  { 201,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant2/Value",
    offsetof(P_ctrl_custom_T, Constant2_Value), 62, 1, 2, 402, 0 },

  { 202,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant3/Value",
    offsetof(P_ctrl_custom_T, Constant3_Value), 62, 1, 2, 404, 0 },

  { 203,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant4/Value",
    offsetof(P_ctrl_custom_T, Constant4_Value), 62, 1, 2, 406, 0 },

  { 204,
    "ctrl_custom/Initialization of parameters/Observer Gains/Constant5/Value",
    offsetof(P_ctrl_custom_T, Constant5_Value), 62, 1, 2, 408, 0 },

  { 205, "ctrl_custom/Referance1/Integrator/InitialCondition", offsetof
    (P_ctrl_custom_T, Integrator_IC_m), 62, 1, 2, 410, 0 },

  { 206, "ctrl_custom/Thruster control /Delay/InitialCondition", offsetof
    (P_ctrl_custom_T, Delay_InitialCondition), 62, 1, 2, 412, 0 },

  { 207, "ctrl_custom/Thruster control /Thruster 1/Constant/Value", offsetof
    (P_ctrl_custom_T, Constant_Value_j[0]), 37, 2, 2, 414, 0 },

  { 208, "ctrl_custom/Thruster control /Thruster 1/Constant1/Value", offsetof
    (P_ctrl_custom_T, Constant1_Value_i[0]), 37, 2, 2, 416, 0 },

  { 209, "ctrl_custom/Thruster control /Thruster 1/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_m), 62, 1, 2, 418, 0 },

  { 210,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_a), 62, 1, 2, 420, 0 },

  { 211,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Constant1/Value",
    offsetof(P_ctrl_custom_T, Constant1_Value_p[0]), 30, 3, 2, 422, 0 },

  { 212,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Constant2/Value",
    offsetof(P_ctrl_custom_T, Constant2_Value_b[0]), 30, 3, 2, 424, 0 },

  { 213,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialStat), 62, 1, 2, 426, 0
  },

  { 214,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Discrete Derivative/TSamp/WtEt",
    offsetof(P_ctrl_custom_T, TSamp_WtEt), 0, 1, 2, 428, 0 },

  { 215,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Acceleration Limit/RisingSlewLimit",
    offsetof(P_ctrl_custom_T, AccelerationLimit_RisingLim), 0, 1, 2, 430, 0 },

  { 216,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Acceleration Limit/FallingSlewLimit",
    offsetof(P_ctrl_custom_T, AccelerationLimit_FallingLim), 0, 1, 2, 432, 0 },

  { 217,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Acceleration Limit/InitialCondition",
    offsetof(P_ctrl_custom_T, AccelerationLimit_IC), 62, 1, 2, 434, 0 },

  { 218, "ctrl_custom/Thruster control /Thruster 1/Thruster control/Memory/X0",
    offsetof(P_ctrl_custom_T, Memory_X0), 62, 1, 2, 436, 0 },

  { 219,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Core controller/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_j), 62, 1, 2, 438, 0 },

  { 220, "ctrl_custom/Thruster control /Thruster 1/Thruster control/NaN/Value",
    offsetof(P_ctrl_custom_T, NaN_Value), 62, 1, 2, 440, 0 },

  { 221,
    "ctrl_custom/Thruster control /Thruster 1/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_i), 62, 1, 2, 442, 0
  },

  { 222, "ctrl_custom/Thruster control /Thruster 2/Constant/Value", offsetof
    (P_ctrl_custom_T, Constant_Value_d[0]), 37, 2, 2, 444, 0 },

  { 223, "ctrl_custom/Thruster control /Thruster 2/Constant1/Value", offsetof
    (P_ctrl_custom_T, Constant1_Value_b[0]), 37, 2, 2, 446, 0 },

  { 224, "ctrl_custom/Thruster control /Thruster 2/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_j), 62, 1, 2, 448, 0 },

  { 225,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_n), 62, 1, 2, 450, 0 },

  { 226,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Constant1/Value",
    offsetof(P_ctrl_custom_T, Constant1_Value_m[0]), 30, 3, 2, 452, 0 },

  { 227,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Constant2/Value",
    offsetof(P_ctrl_custom_T, Constant2_Value_k[0]), 30, 3, 2, 454, 0 },

  { 228,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_f), 62, 1, 2, 456, 0
  },

  { 229,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Discrete Derivative/TSamp/WtEt",
    offsetof(P_ctrl_custom_T, TSamp_WtEt_g), 0, 1, 2, 458, 0 },

  { 230,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Acceleration Limit/RisingSlewLimit",
    offsetof(P_ctrl_custom_T, AccelerationLimit_RisingLim_p), 0, 1, 2, 460, 0 },

  { 231,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Acceleration Limit/FallingSlewLimit",
    offsetof(P_ctrl_custom_T, AccelerationLimit_FallingLim_n), 0, 1, 2, 462, 0 },

  { 232,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Acceleration Limit/InitialCondition",
    offsetof(P_ctrl_custom_T, AccelerationLimit_IC_l), 62, 1, 2, 464, 0 },

  { 233, "ctrl_custom/Thruster control /Thruster 2/Thruster control/Memory/X0",
    offsetof(P_ctrl_custom_T, Memory_X0_h), 62, 1, 2, 466, 0 },

  { 234,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Core controller/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_p), 62, 1, 2, 468, 0 },

  { 235, "ctrl_custom/Thruster control /Thruster 2/Thruster control/NaN/Value",
    offsetof(P_ctrl_custom_T, NaN_Value_n), 62, 1, 2, 470, 0 },

  { 236,
    "ctrl_custom/Thruster control /Thruster 2/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_p), 62, 1, 2, 472, 0
  },

  { 237, "ctrl_custom/Thruster control /Thruster 3/Constant/Value", offsetof
    (P_ctrl_custom_T, Constant_Value_gq[0]), 37, 2, 2, 474, 0 },

  { 238, "ctrl_custom/Thruster control /Thruster 3/Constant1/Value", offsetof
    (P_ctrl_custom_T, Constant1_Value_l[0]), 37, 2, 2, 476, 0 },

  { 239, "ctrl_custom/Thruster control /Thruster 3/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_b), 62, 1, 2, 478, 0 },

  { 240,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_o), 62, 1, 2, 480, 0 },

  { 241,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Constant1/Value",
    offsetof(P_ctrl_custom_T, Constant1_Value_c[0]), 30, 3, 2, 482, 0 },

  { 242,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Constant2/Value",
    offsetof(P_ctrl_custom_T, Constant2_Value_k5[0]), 30, 3, 2, 484, 0 },

  { 243,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_h), 62, 1, 2, 486, 0
  },

  { 244,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Discrete Derivative/TSamp/WtEt",
    offsetof(P_ctrl_custom_T, TSamp_WtEt_i), 0, 1, 2, 488, 0 },

  { 245,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Acceleration limiter/RisingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_RisingLim), 0, 1, 2, 490, 0 },

  { 246,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Acceleration limiter/FallingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_FallingLim), 0, 1, 2, 492, 0 },

  { 247,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Acceleration limiter/InitialCondition",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_IC), 62, 1, 2, 494, 0 },

  { 248, "ctrl_custom/Thruster control /Thruster 3/Thruster control/Memory/X0",
    offsetof(P_ctrl_custom_T, Memory_X0_d), 62, 1, 2, 496, 0 },

  { 249,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Core controller/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_k), 62, 1, 2, 498, 0 },

  { 250, "ctrl_custom/Thruster control /Thruster 3/Thruster control/NaN/Value",
    offsetof(P_ctrl_custom_T, NaN_Value_k), 62, 1, 2, 500, 0 },

  { 251,
    "ctrl_custom/Thruster control /Thruster 3/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_n), 62, 1, 2, 502, 0
  },

  { 252, "ctrl_custom/Thruster control /Thruster 4/Constant/Value", offsetof
    (P_ctrl_custom_T, Constant_Value_m[0]), 37, 2, 2, 504, 0 },

  { 253, "ctrl_custom/Thruster control /Thruster 4/Constant1/Value", offsetof
    (P_ctrl_custom_T, Constant1_Value_h[0]), 37, 2, 2, 506, 0 },

  { 254, "ctrl_custom/Thruster control /Thruster 4/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_d), 62, 1, 2, 508, 0 },

  { 255,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_b4), 62, 1, 2, 510, 0 },

  { 256,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Constant1/Value",
    offsetof(P_ctrl_custom_T, Constant1_Value_d[0]), 30, 3, 2, 512, 0 },

  { 257,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Constant2/Value",
    offsetof(P_ctrl_custom_T, Constant2_Value_h[0]), 30, 3, 2, 514, 0 },

  { 258,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialS_nq), 62, 1, 2, 516, 0
  },

  { 259,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Discrete Derivative/TSamp/WtEt",
    offsetof(P_ctrl_custom_T, TSamp_WtEt_n), 0, 1, 2, 518, 0 },

  { 260,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Acceleration limiter/RisingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_RisingLim_i), 0, 1, 2, 520, 0
  },

  { 261,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Acceleration limiter/FallingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_FallingLi_i), 0, 1, 2, 522, 0
  },

  { 262,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Acceleration limiter/InitialCondition",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_IC_i), 62, 1, 2, 524, 0 },

  { 263, "ctrl_custom/Thruster control /Thruster 4/Thruster control/Memory/X0",
    offsetof(P_ctrl_custom_T, Memory_X0_b), 62, 1, 2, 526, 0 },

  { 264,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Core controller/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_l), 62, 1, 2, 528, 0 },

  { 265, "ctrl_custom/Thruster control /Thruster 4/Thruster control/NaN/Value",
    offsetof(P_ctrl_custom_T, NaN_Value_ks), 62, 1, 2, 530, 0 },

  { 266,
    "ctrl_custom/Thruster control /Thruster 4/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_g), 62, 1, 2, 532, 0
  },

  { 267, "ctrl_custom/Thruster control /Thruster 5/Constant/Value", offsetof
    (P_ctrl_custom_T, Constant_Value_gh[0]), 37, 2, 2, 534, 0 },

  { 268, "ctrl_custom/Thruster control /Thruster 5/Constant1/Value", offsetof
    (P_ctrl_custom_T, Constant1_Value_e[0]), 37, 2, 2, 536, 0 },

  { 269, "ctrl_custom/Thruster control /Thruster 5/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_g), 62, 1, 2, 538, 0 },

  { 270,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_p), 62, 1, 2, 540, 0 },

  { 271,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Constant1/Value",
    offsetof(P_ctrl_custom_T, Constant1_Value_k[0]), 30, 3, 2, 542, 0 },

  { 272,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Constant2/Value",
    offsetof(P_ctrl_custom_T, Constant2_Value_b0[0]), 30, 3, 2, 544, 0 },

  { 273,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialS_il), 62, 1, 2, 546, 0
  },

  { 274,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Discrete Derivative/TSamp/WtEt",
    offsetof(P_ctrl_custom_T, TSamp_WtEt_ih), 0, 1, 2, 548, 0 },

  { 275,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Acceleration limiter/RisingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_RisingLim_k), 0, 1, 2, 550, 0
  },

  { 276,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Acceleration limiter/FallingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_FallingLi_c), 0, 1, 2, 552, 0
  },

  { 277,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Acceleration limiter/InitialCondition",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_IC_d), 62, 1, 2, 554, 0 },

  { 278, "ctrl_custom/Thruster control /Thruster 5/Thruster control/Memory/X0",
    offsetof(P_ctrl_custom_T, Memory_X0_n), 62, 1, 2, 556, 0 },

  { 279,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Core controller/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_hh), 62, 1, 2, 558, 0 },

  { 280, "ctrl_custom/Thruster control /Thruster 5/Thruster control/NaN/Value",
    offsetof(P_ctrl_custom_T, NaN_Value_ny), 62, 1, 2, 560, 0 },

  { 281,
    "ctrl_custom/Thruster control /Thruster 5/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_k), 62, 1, 2, 562, 0
  },

  { 282, "ctrl_custom/Thruster control /Thruster 6/Constant/Value", offsetof
    (P_ctrl_custom_T, Constant_Value_b[0]), 37, 2, 2, 564, 0 },

  { 283, "ctrl_custom/Thruster control /Thruster 6/Constant1/Value", offsetof
    (P_ctrl_custom_T, Constant1_Value_oi[0]), 37, 2, 2, 566, 0 },

  { 284, "ctrl_custom/Thruster control /Thruster 6/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_md), 62, 1, 2, 568, 0 },

  { 285,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, Delay_InitialCondition_gp), 62, 1, 2, 570, 0 },

  { 286,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Constant1/Value",
    offsetof(P_ctrl_custom_T, Constant1_Value_pu[0]), 30, 3, 2, 572, 0 },

  { 287,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Constant2/Value",
    offsetof(P_ctrl_custom_T, Constant2_Value_p[0]), 30, 3, 2, 574, 0 },

  { 288,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialS_fz), 62, 1, 2, 576, 0
  },

  { 289,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Discrete Derivative/TSamp/WtEt",
    offsetof(P_ctrl_custom_T, TSamp_WtEt_l), 0, 1, 2, 578, 0 },

  { 290,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Acceleration limiter/RisingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_RisingLim_b), 0, 1, 2, 580, 0
  },

  { 291,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Acceleration limiter/FallingSlewLimit",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_FallingLi_j), 0, 1, 2, 582, 0
  },

  { 292,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Acceleration limiter/InitialCondition",
    offsetof(P_ctrl_custom_T, Accelerationlimiter_IC_g), 62, 1, 2, 584, 0 },

  { 293, "ctrl_custom/Thruster control /Thruster 6/Thruster control/Memory/X0",
    offsetof(P_ctrl_custom_T, Memory_X0_m), 62, 1, 2, 586, 0 },

  { 294,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Core controller/Integrator/InitialCondition",
    offsetof(P_ctrl_custom_T, Integrator_IC_pr), 62, 1, 2, 588, 0 },

  { 295, "ctrl_custom/Thruster control /Thruster 6/Thruster control/NaN/Value",
    offsetof(P_ctrl_custom_T, NaN_Value_m), 62, 1, 2, 590, 0 },

  { 296,
    "ctrl_custom/Thruster control /Thruster 6/Discrete Transfer Fcn/Numerator",
    offsetof(P_ctrl_custom_T, DiscreteTransferFcn_InitialSt_j), 62, 1, 2, 592, 0
  },

  { 297, "ctrl_custom/Thruster control /Delay/DelayLength", offsetof
    (P_ctrl_custom_T, Delay_DelayLength), 63, 1, 2, 594, 0 },

  { 298, "ctrl_custom/Thruster control /Thruster 1/Delay/DelayLength", offsetof
    (P_ctrl_custom_T, Delay_DelayLength_a), 63, 1, 2, 596, 0 },

  { 299,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Delay/DelayLength",
    offsetof(P_ctrl_custom_T, Delay_DelayLength_h), 63, 1, 2, 598, 0 },

  { 300, "ctrl_custom/Thruster control /Thruster 2/Delay/DelayLength", offsetof
    (P_ctrl_custom_T, Delay_DelayLength_f), 63, 1, 2, 600, 0 },

  { 301,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Delay/DelayLength",
    offsetof(P_ctrl_custom_T, Delay_DelayLength_o), 63, 1, 2, 602, 0 },

  { 302, "ctrl_custom/Thruster control /Thruster 3/Delay/DelayLength", offsetof
    (P_ctrl_custom_T, Delay_DelayLength_e), 63, 1, 2, 604, 0 },

  { 303,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Delay/DelayLength",
    offsetof(P_ctrl_custom_T, Delay_DelayLength_o2), 63, 1, 2, 606, 0 },

  { 304, "ctrl_custom/Thruster control /Thruster 4/Delay/DelayLength", offsetof
    (P_ctrl_custom_T, Delay_DelayLength_k), 63, 1, 2, 608, 0 },

  { 305,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/Delay/DelayLength",
    offsetof(P_ctrl_custom_T, Delay_DelayLength_kr), 63, 1, 2, 610, 0 },

  { 306, "ctrl_custom/Thruster control /Thruster 5/Delay/DelayLength", offsetof
    (P_ctrl_custom_T, Delay_DelayLength_n), 63, 1, 2, 612, 0 },

  { 307,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Delay/DelayLength",
    offsetof(P_ctrl_custom_T, Delay_DelayLength_n4), 63, 1, 2, 614, 0 },

  { 308, "ctrl_custom/Thruster control /Thruster 6/Delay/DelayLength", offsetof
    (P_ctrl_custom_T, Delay_DelayLength_ho), 63, 1, 2, 616, 0 },

  { 309,
    "ctrl_custom/Thruster control /Thruster 6/Thruster control/Delay/DelayLength",
    offsetof(P_ctrl_custom_T, Delay_DelayLength_hw), 63, 1, 2, 618, 0 },
  ...
  { 311,
    ...
    offsetof(P_ctrl_custom_T, CoreSubsys.Gain1_Gain), 62, 1, 2, 622, 0 },

  { 312,
    "ctrl_custom/Thrust allocation/Optimal angle path and  constraints on rotation speed/Delay/InitialCondition",
    offsetof(P_ctrl_custom_T, CoreSubsys.Delay_InitialCondition), 62, 1, 2, 624,
    0 },

  { 313,
    "ctrl_custom/Thrust allocation/Optimal angle path and  constraints on rotation speed/Delay/DelayLength",
    offsetof(P_ctrl_custom_T, CoreSubsys.Delay_DelayLength), 63, 1, 2, 626, 0 },
};

static int32_t NI_ParamListSize DataSection(".NIVS.paramlistsize") = 314;
static int32_t NI_ParamDimList[] DataSection(".NIVS.paramdimlist") =
{
  ...
  1, 6,                                /* Parameter at index 100 */
  1, 6,                                /* Parameter at index 101 */
  ...
  3, 1,                                /* Parameter at index 146 */
  1, 1,                                /* Parameter at index 147 */
  1, 1,                                /* Parameter at index 148 */
  1, 1,                                /* Parameter at index 149 */
  3, 3,                                /* Parameter at index 150 */
  1, 1,                                /* Parameter at index 151 */
  1, 6,                                /* Parameter at index 152 */
  1, 6,                                /* Parameter at index 153 */
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 21, "ctrl_custom/PID controller1/Sum4", 0, "regulation error(1, 1)",
    offsetof(B_ctrl_custom_T, regulationerror) + (0*sizeof(real_T)), BLOCKIO_SIG,
    22, 1, 2, 0, 0 },

  { 22, "ctrl_custom/PID controller1/Sum4", 0, "regulation error(1, 2)",
    offsetof(B_ctrl_custom_T, regulationerror) + (1*sizeof(real_T)), BLOCKIO_SIG,
    22, 1, 2, 0, 0 },

  { 23, "ctrl_custom/PID controller1/Sum4", 0, "regulation error(1, 3)",
    offsetof(B_ctrl_custom_T, regulationerror) + (2*sizeof(real_T)), BLOCKIO_SIG,
    22, 1, 2, 0, 0 },

  { 24, "ctrl_custom/Referance1/Integrator1/(1, 1)", 0, "", offsetof
    (B_ctrl_custom_T, Integrator1) + (0*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2,
    0, 0 },

  { 25, "ctrl_custom/Referance1/Integrator1/(1, 2)", 0, "", offsetof
    (B_ctrl_custom_T, Integrator1) + (1*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2,
    0, 0 },

  { 26, "ctrl_custom/Referance1/Integrator1/(1, 3)", 0, "", offsetof
  ...
  { 30, "ctrl_custom/PID controller1/Sum1/(1, 1)", 0, "", offsetof
    (B_ctrl_custom_T, Sum1) + (0*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 31, "ctrl_custom/PID controller1/Sum1/(1, 2)", 0, "", offsetof
    (B_ctrl_custom_T, Sum1) + (1*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 32, "ctrl_custom/PID controller1/Sum1/(1, 3)", 0, "", offsetof
    (B_ctrl_custom_T, Sum1) + (2*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 33, "ctrl_custom/Gain5", 0, "", offsetof(B_ctrl_custom_T, Gain5) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 34, "ctrl_custom/Gain", 0, "", offsetof(B_ctrl_custom_T, Gain_h) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 35, "ctrl_custom/Nonlinear Passisve Observer/Integrator2/(1, 1)", 0, "",
    offsetof(B_ctrl_custom_T, Integrator2) + (0*sizeof(real_T)), BLOCKIO_SIG, 22,
    1, 2, 0, 0 },

  { 36, "ctrl_custom/Nonlinear Passisve Observer/Integrator2/(1, 2)", 0, "",
    offsetof(B_ctrl_custom_T, Integrator2) + (1*sizeof(real_T)), BLOCKIO_SIG, 22,
    1, 2, 0, 0 },

  { 37, "ctrl_custom/Nonlinear Passisve Observer/Integrator2/(1, 3)", 0, "",
  ...
  { 47, "ctrl_custom/Nonlinear Passisve Observer/M^-1/(1, 1)", 0, "", offsetof
    (B_ctrl_custom_T, M1) + (0*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 48, "ctrl_custom/Nonlinear Passisve Observer/M^-1/(1, 2)", 0, "", offsetof
    (B_ctrl_custom_T, M1) + (1*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 49, "ctrl_custom/Nonlinear Passisve Observer/M^-1/(1, 3)", 0, "", offsetof
    (B_ctrl_custom_T, M1) + (2*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 50, "ctrl_custom/Thruster measurment/thr_angle_1", 0, "", offsetof
    (B_ctrl_custom_T, thr_angle_1) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 51, "ctrl_custom/Thruster measurment/thr_angle_2", 0, "", offsetof
    (B_ctrl_custom_T, thr_angle_2) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 52, "ctrl_custom/Thruster measurment/thr_angle_3", 0, "", offsetof
    (B_ctrl_custom_T, thr_angle_3) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 53, "ctrl_custom/Thruster measurment/thr_angle_4", 0, "", offsetof
    (B_ctrl_custom_T, thr_angle_4) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 54, "ctrl_custom/Thruster measurment/thr_angle_5", 0, "", offsetof
    (B_ctrl_custom_T, thr_angle_5) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 55, "ctrl_custom/Thruster measurment/thr_angle_6", 0, "", offsetof
    (B_ctrl_custom_T, thr_angle_6) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 56, "ctrl_custom/Thrust allocation/reset/(1, 1)", 0, "", offsetof
    (B_ctrl_custom_T, reset) + (0*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 57, "ctrl_custom/Thrust allocation/reset/(1, 2)", 0, "", offsetof
    (B_ctrl_custom_T, reset) + (1*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 58, "ctrl_custom/Thrust allocation/reset/(1, 3)", 0, "", offsetof
    (B_ctrl_custom_T, reset) + (2*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 59, "ctrl_custom/Thrust allocation/reset/(1, 4)", 0, "", offsetof
    (B_ctrl_custom_T, reset) + (3*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 60, "ctrl_custom/Thrust allocation/reset/(1, 5)", 0, "", offsetof
    (B_ctrl_custom_T, reset) + (4*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 61, "ctrl_custom/Thrust allocation/reset/(1, 6)", 0, "", offsetof
    (B_ctrl_custom_T, reset) + (5*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 62, "ctrl_custom/Thrust allocation/Angle_controller", 0, "", offsetof
    (B_ctrl_custom_T, Angle_controller) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 63, "ctrl_custom/Thrust allocation/Choosing Fixed // Azimuth angle/(1, 1)",
    0, "", offsetof(B_ctrl_custom_T, ChoosingFixedAzimuthangle) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 64, "ctrl_custom/Thrust allocation/Choosing Fixed // Azimuth angle/(1, 2)",
    0, "", offsetof(B_ctrl_custom_T, ChoosingFixedAzimuthangle) + (1*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 65, "ctrl_custom/Thrust allocation/Choosing Fixed // Azimuth angle/(1, 3)",
    0, "", offsetof(B_ctrl_custom_T, ChoosingFixedAzimuthangle) + (2*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 66, "ctrl_custom/Thrust allocation/Choosing Fixed // Azimuth angle/(1, 4)",
    0, "", offsetof(B_ctrl_custom_T, ChoosingFixedAzimuthangle) + (3*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 67, "ctrl_custom/Thrust allocation/Choosing Fixed // Azimuth angle/(1, 5)",
    0, "", offsetof(B_ctrl_custom_T, ChoosingFixedAzimuthangle) + (4*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 68, "ctrl_custom/Thrust allocation/Choosing Fixed // Azimuth angle/(1, 6)",
    0, "", offsetof(B_ctrl_custom_T, ChoosingFixedAzimuthangle) + (5*sizeof
    (real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 69, "ctrl_custom/Thruster control /Subsystem1/Saturation 1", 0, "", offsetof
    (B_ctrl_custom_T, Saturation1) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 70, "ctrl_custom/Thruster control /Subsystem1/Saturation 2", 0, "", offsetof
    (B_ctrl_custom_T, Saturation2) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 71, "ctrl_custom/Thruster control /Subsystem1/Saturation 3", 0, "", offsetof
    (B_ctrl_custom_T, Saturation3) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 72, "ctrl_custom/Thruster control /Subsystem1/Saturation 4", 0, "", offsetof
    (B_ctrl_custom_T, Saturation4) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 73, "ctrl_custom/Thruster control /Subsystem1/Saturation 5", 0, "", offsetof
    (B_ctrl_custom_T, Saturation5) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 74, "ctrl_custom/Thruster control /Subsystem1/Saturation 6", 0, "", offsetof
    (B_ctrl_custom_T, Saturation6) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 75, "ctrl_custom/Thruster control /Thruster 1/Shaft dynamics/reset", 0, "",
    offsetof(B_ctrl_custom_T, reset_c) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 76, "ctrl_custom/Thruster control /Thruster 2/Shaft dynamics/reset", 0, "",
    offsetof(B_ctrl_custom_T, reset_e) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 77, "ctrl_custom/Thruster control /Thruster 3/Shaft dynamics/reset", 0, "",
    offsetof(B_ctrl_custom_T, reset_n) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 78, "ctrl_custom/Thruster control /Thruster 4/Shaft dynamics/reset", 0, "",
    offsetof(B_ctrl_custom_T, reset_i) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 79, "ctrl_custom/Thruster control /Thruster 5/Shaft dynamics/reset", 0, "",
    offsetof(B_ctrl_custom_T, reset_nr) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 80, "ctrl_custom/Thruster control /Thruster 6/Shaft dynamics/reset", 0, "",
    offsetof(B_ctrl_custom_T, reset_l) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },
  ...
  { 87, "ctrl_custom/Gain1", 0, "", offsetof(B_ctrl_custom_T, Gain1_n) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },
  ...
  { 112, "ctrl_custom/Referance1/x_ref", 0, "", offsetof(B_ctrl_custom_T, x_ref)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 113, "ctrl_custom/Referance1/y_ref", 0, "", offsetof(B_ctrl_custom_T, y_ref)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 114, "ctrl_custom/Initialization of parameters/Guidance Gains/w_x", 0, "",
    offsetof(B_ctrl_custom_T, w_x) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 115, "ctrl_custom/Initialization of parameters/Guidance Gains/w_y", 0, "",
    offsetof(B_ctrl_custom_T, w_y) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 116, "ctrl_custom/Initialization of parameters/Guidance Gains/w_psi", 0, "",
    offsetof(B_ctrl_custom_T, w_psi) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 117, "ctrl_custom/Initialization of parameters/Guidance Gains/zeta_psi", 0,
    "", offsetof(B_ctrl_custom_T, zeta_psi) + (0*sizeof(real_T)), BLOCKIO_SIG, 0,
    1, 2, 0, 0 },

  { 118, "ctrl_custom/Initialization of parameters/Guidance Gains/zeta_x", 0, "",
    offsetof(B_ctrl_custom_T, zeta_x) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 119, "ctrl_custom/Initialization of parameters/Guidance Gains/zeta_y", 0, "",
    offsetof(B_ctrl_custom_T, zeta_y) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 120, "ctrl_custom/Initialization of parameters/Guidance Gains/T_psi", 0, "",
    offsetof(B_ctrl_custom_T, T_psi) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 121, "ctrl_custom/Initialization of parameters/Guidance Gains/T_x", 0, "",
    offsetof(B_ctrl_custom_T, T_x) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 122, "ctrl_custom/Initialization of parameters/Guidance Gains/T_y", 0, "",
    offsetof(B_ctrl_custom_T, T_y) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0,
    0 },

  { 123, "ctrl_custom/Referance1/psi_ref", 0, "", offsetof(B_ctrl_custom_T,
    psi_ref) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 124, "ctrl_custom/Referance1/Sum/(1, 1)", 0, "", offsetof(B_ctrl_custom_T,
    Sum_m) + (0*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 125, "ctrl_custom/Referance1/Sum/(1, 2)", 0, "", offsetof(B_ctrl_custom_T,
    Sum_m) + (1*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 126, "ctrl_custom/Referance1/Sum/(1, 3)", 0, "", offsetof(B_ctrl_custom_T,
    Sum_m) + (2*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 127, "ctrl_custom/Referance1/Sum2/(1, 1)", 0, "", offsetof(B_ctrl_custom_T,
    Sum2) + (0*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 128, "ctrl_custom/Referance1/Sum2/(1, 2)", 0, "", offsetof(B_ctrl_custom_T,
    Sum2) + (1*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 129, "ctrl_custom/Referance1/Sum2/(1, 3)", 0, "", offsetof(B_ctrl_custom_T,
    Sum2) + (2*sizeof(real_T)), BLOCKIO_SIG, 22, 1, 2, 0, 0 },

  { 130, "ctrl_custom/Thruster control /Delay/(1, 1)", 0, "", offsetof
    (B_ctrl_custom_T, Delay) + (0*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 131, "ctrl_custom/Thruster control /Delay/(1, 2)", 0, "", offsetof
    (B_ctrl_custom_T, Delay) + (1*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 132, "ctrl_custom/Thruster control /Delay/(1, 3)", 0, "", offsetof
    (B_ctrl_custom_T, Delay) + (2*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 133, "ctrl_custom/Thruster control /Delay/(1, 4)", 0, "", offsetof
    (B_ctrl_custom_T, Delay) + (3*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 134, "ctrl_custom/Thruster control /Delay/(1, 5)", 0, "", offsetof
    (B_ctrl_custom_T, Delay) + (4*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 135, "ctrl_custom/Thruster control /Delay/(1, 6)", 0, "", offsetof
    (B_ctrl_custom_T, Delay) + (5*sizeof(real_T)), BLOCKIO_SIG, 25, 1, 2, 0, 0 },

  { 136, "ctrl_custom/Thruster control /Thruster 1/Delay", 0, "", offsetof
    (B_ctrl_custom_T, Delay_d) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0
  },

  { 137, "ctrl_custom/Thruster control /Thruster 1/Thruster control/Delay", 0,
  ...
  { 141, "ctrl_custom/Thruster control /Thruster 1/Thruster control/Sum1", 0, "",
    offsetof(B_ctrl_custom_T, Sum1_b) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 142, "ctrl_custom/Thruster control /Thruster 1/Thruster control/Memory", 0,
  ...
  { 144,
    "ctrl_custom/Thruster control /Thruster 1/Thruster control/Core controller/reset",
    0, "", offsetof(B_ctrl_custom_T, reset_p) + (0*sizeof(real_T)), BLOCKIO_SIG,
    0, 1, 2, 0, 0 },

  { 145, "ctrl_custom/Thruster control /Thruster 1/Thruster control/Sum", 0, "",
    offsetof(B_ctrl_custom_T, Sum_hk) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 146, "ctrl_custom/Thruster control /Thruster 1/Discrete Transfer Fcn", 0, "",
  ...
  { 149, "ctrl_custom/Thruster control /Thruster 2/Delay", 0, "", offsetof
    (B_ctrl_custom_T, Delay_c) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0
  },

  { 150, "ctrl_custom/Thruster control /Thruster 2/Thruster control/Delay", 0,
  ...
  { 154, "ctrl_custom/Thruster control /Thruster 2/Thruster control/Sum1", 0, "",
    offsetof(B_ctrl_custom_T, Sum1_l) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 155, "ctrl_custom/Thruster control /Thruster 2/Thruster control/Memory", 0,
  ...
  { 157,
    "ctrl_custom/Thruster control /Thruster 2/Thruster control/Core controller/reset",
    0, "", offsetof(B_ctrl_custom_T, reset_l2) + (0*sizeof(real_T)), BLOCKIO_SIG,
    0, 1, 2, 0, 0 },

  { 158, "ctrl_custom/Thruster control /Thruster 2/Thruster control/Sum", 0, "",
    offsetof(B_ctrl_custom_T, Sum_d) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 159, "ctrl_custom/Thruster control /Thruster 2/Discrete Transfer Fcn", 0, "",
  ...
  { 162, "ctrl_custom/Thruster control /Thruster 3/Delay", 0, "", offsetof
    (B_ctrl_custom_T, Delay_h) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0
  },

  { 163, "ctrl_custom/Thruster control /Thruster 3/Thruster control/Delay", 0,
  ...
  { 167, "ctrl_custom/Thruster control /Thruster 3/Thruster control/Sum1", 0, "",
    offsetof(B_ctrl_custom_T, Sum1_c) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 168, "ctrl_custom/Thruster control /Thruster 3/Thruster control/Memory", 0,
  ...
  { 170,
    "ctrl_custom/Thruster control /Thruster 3/Thruster control/Core controller/reset",
    0, "", offsetof(B_ctrl_custom_T, reset_i0) + (0*sizeof(real_T)), BLOCKIO_SIG,
    0, 1, 2, 0, 0 },

  { 171, "ctrl_custom/Thruster control /Thruster 3/Thruster control/Sum", 0, "",
    offsetof(B_ctrl_custom_T, Sum_n) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 172, "ctrl_custom/Thruster control /Thruster 3/Discrete Transfer Fcn", 0, "",
  ...
  { 175, "ctrl_custom/Thruster control /Thruster 4/Delay", 0, "", offsetof
    (B_ctrl_custom_T, Delay_e) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0
  },

  { 176, "ctrl_custom/Thruster control /Thruster 4/Thruster control/Delay", 0,
  ...
  { 180, "ctrl_custom/Thruster control /Thruster 4/Thruster control/Sum1", 0, "",
    offsetof(B_ctrl_custom_T, Sum1_cp) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1,
    2, 0, 0 },

  { 181, "ctrl_custom/Thruster control /Thruster 4/Thruster control/Memory", 0,
  ...
  { 184, "ctrl_custom/Thruster control /Thruster 4/Thruster control/Sum", 0, "",
    offsetof(B_ctrl_custom_T, Sum_a) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 185, "ctrl_custom/Thruster control /Thruster 4/Discrete Transfer Fcn", 0, "",
  ...
  { 188, "ctrl_custom/Thruster control /Thruster 5/Delay", 0, "", offsetof
    (B_ctrl_custom_T, Delay_jj) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0
  },

  { 189, "ctrl_custom/Thruster control /Thruster 5/Thruster control/Delay", 0,
  ...
  { 193, "ctrl_custom/Thruster control /Thruster 5/Thruster control/Sum1", 0, "",
    offsetof(B_ctrl_custom_T, Sum1_e) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 194, "ctrl_custom/Thruster control /Thruster 5/Thruster control/Memory", 0,
  ...
  { 196,
    "ctrl_custom/Thruster control /Thruster 5/Thruster control/Core controller/reset",
    0, "", offsetof(B_ctrl_custom_T, reset_ep) + (0*sizeof(real_T)), BLOCKIO_SIG,
    0, 1, 2, 0, 0 },

  { 197, "ctrl_custom/Thruster control /Thruster 5/Thruster control/Sum", 0, "",
    offsetof(B_ctrl_custom_T, Sum_f) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 198, "ctrl_custom/Thruster control /Thruster 5/Discrete Transfer Fcn", 0, "",
  ...
  { 201, "ctrl_custom/Thruster control /Thruster 6/Delay", 0, "", offsetof
    (B_ctrl_custom_T, Delay_mu) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0
  },

  { 202, "ctrl_custom/Thruster control /Thruster 6/Thruster control/Delay", 0,
  ...
  { 206, "ctrl_custom/Thruster control /Thruster 6/Thruster control/Sum1", 0, "",
    offsetof(B_ctrl_custom_T, Sum1_p) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 207, "ctrl_custom/Thruster control /Thruster 6/Thruster control/Memory", 0,
  ...
  { 210, "ctrl_custom/Thruster control /Thruster 6/Thruster control/Sum", 0, "",
    offsetof(B_ctrl_custom_T, Sum_g) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2,
    0, 0 },

  { 211, "ctrl_custom/Thruster control /Thruster 6/Discrete Transfer Fcn", 0, "",
  ...
  { 214, "ctrl_custom/IMU/Acc_x", 0, "", offsetof(B_ctrl_custom_T, Acc_x) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 215, "ctrl_custom/IMU/Acc_y", 0, "", offsetof(B_ctrl_custom_T, Acc_y) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 216, "ctrl_custom/IMU/Acc_z", 0, "", offsetof(B_ctrl_custom_T, Acc_z) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 217, "ctrl_custom/IMU/Gyro_x", 0, "", offsetof(B_ctrl_custom_T, Gyro_x) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 218, "ctrl_custom/IMU/Gyro_y", 0, "", offsetof(B_ctrl_custom_T, Gyro_y) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 219, "ctrl_custom/IMU/Gyro_z", 0, "", offsetof(B_ctrl_custom_T, Gyro_z) + (0*
    sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },
  ...
  { 238, "ctrl_custom/Thruster control /Thruster 6/Thruster control/Supervisor",
  ...
  { 244, "ctrl_custom/Thruster control /Thruster 5/Thruster control/Supervisor",
  ...
  { 252, "ctrl_custom/Thruster control /Thruster 4/Thruster control/Supervisor",
  ...
  { 253,
    ...
    0, "", offsetof(B_ctrl_custom_T, sf_MATLABFunction_dv.n_d) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 254,
    "ctrl_custom/Thruster control /Thruster 4/Thruster control/MATLAB Function",
    1, "", offsetof(B_ctrl_custom_T, sf_MATLABFunction_dv.T_r) + (0*sizeof
    (real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },
  ...
  { 260, "ctrl_custom/Thruster control /Thruster 3/Thruster control/Supervisor",
  ...
  { 266, "ctrl_custom/Thruster control /Thruster 2/Thruster control/Supervisor",
  ...
  { 274, "ctrl_custom/Thruster control /Thruster 1/Thruster control/Supervisor",
...
static int32_t NI_SigListSize DataSection(".NIVS.siglistsize") = 304;
...
static NI_ExternalIO NI_ExtList[] DataSection(".NIVS.extlist") =
{
  ...
  { 15, "Thruster measurment/thr_angle_1", 0, EXT_IN, 1, 1, 1 },

  { 16, "Thruster measurment/thr_angle_2", 0, EXT_IN, 1, 1, 1 },

  { 17, "Thruster measurment/thr_angle_3", 0, EXT_IN, 1, 1, 1 },

  { 18, "Thruster measurment/thr_angle_4", 0, EXT_IN, 1, 1, 1 },

  { 19, "Thruster measurment/thr_angle_5", 0, EXT_IN, 1, 1, 1 },

  { 20, "Thruster measurment/thr_angle_6", 0, EXT_IN, 1, 1, 1 },

  { 21, "Thrust allocation/reset", 1, EXT_IN, 6, 6, 1 },

  { 22, "Thrust allocation/Angle_controller", 0, EXT_IN, 1, 1, 1 },

  { 23, "Thruster control /Thruster 1/Shaft dynamics/reset", 0, EXT_IN, 1, 1, 1
  },

  { 24, "Thruster control /Thruster 2/Shaft dynamics/reset", 0, EXT_IN, 1, 1, 1
  },

  { 25, "Thruster control /Thruster 3/Shaft dynamics/reset", 0, EXT_IN, 1, 1, 1
  },

  { 26, "Thruster control /Thruster 4/Shaft dynamics/reset", 0, EXT_IN, 1, 1, 1
  },

  { 27, "Thruster control /Thruster 5/Shaft dynamics/reset", 0, EXT_IN, 1, 1, 1
  },

  { 28, "Thruster control /Thruster 6/Shaft dynamics/reset", 0, EXT_IN, 1, 1, 1
  },

  { 29, "Thruster control /Thrust and Shaft speed mapped to PWM/rpm1 ", 0,
    EXT_IN, 1, 1, 1 },

  { 30, "Thruster control /Thrust and Shaft speed mapped to PWM/rpm2", 0, EXT_IN,
    1, 1, 1 },

  { 31, "Thruster control /Thrust and Shaft speed mapped to PWM/rpm3", 0, EXT_IN,
    1, 1, 1 },

  { 32, "Thruster control /Thrust and Shaft speed mapped to PWM/rpm4", 0, EXT_IN,
    1, 1, 1 },

  { 33, "Thruster control /Thrust and Shaft speed mapped to PWM/rpm5", 0, EXT_IN,
    1, 1, 1 },

  { 34, "Thruster control /Thrust and Shaft speed mapped to PWM/rpm6", 0, EXT_IN,
    1, 1, 1 },

  { 35, "Referance1/x_ref", 0, EXT_IN, 1, 1, 1 },

  { 36, "Referance1/y_ref", 0, EXT_IN, 1, 1, 1 },

  { 37, "Initialization of parameters/Guidance Gains/w_x", 0, EXT_IN, 1, 1, 1 },

  { 38, "Initialization of parameters/Guidance Gains/w_y", 0, EXT_IN, 1, 1, 1 },

  { 39, "Initialization of parameters/Guidance Gains/w_psi", 0, EXT_IN, 1, 1, 1
  },

  { 40, "Initialization of parameters/Guidance Gains/zeta_psi", 0, EXT_IN, 1, 1,
    1 },

  { 41, "Initialization of parameters/Guidance Gains/zeta_x", 0, EXT_IN, 1, 1, 1
  },

  { 42, "Initialization of parameters/Guidance Gains/zeta_y", 0, EXT_IN, 1, 1, 1
  },

  { 43, "Initialization of parameters/Guidance Gains/T_psi", 0, EXT_IN, 1, 1, 1
  },

  { 44, "Initialization of parameters/Guidance Gains/T_x", 0, EXT_IN, 1, 1, 1 },

  { 45, "Initialization of parameters/Guidance Gains/T_y", 0, EXT_IN, 1, 1, 1 },

  { 46, "Referance1/psi_ref", 0, EXT_IN, 1, 1, 1 },
  ...
  { 53, "IMU/Acc_x", 1, EXT_IN, 1, 1, 1 },

  { 54, "IMU/Acc_y", 1, EXT_IN, 1, 1, 1 },

  { 55, "IMU/Acc_z", 1, EXT_IN, 1, 1, 1 },

  { 56, "IMU/Gyro_x", 1, EXT_IN, 1, 1, 1 },

  { 57, "IMU/Gyro_y", 1, EXT_IN, 1, 1, 1 },

  { 58, "IMU/Gyro_z", 1, EXT_IN, 1, 1, 1 },
  ...
  { 7, "Observer output /eta_hat output/x_hat", 0, EXT_OUT, 1, 1, 1 },

  { 8, "Observer output /eta_hat output/y_hat", 0, EXT_OUT, 1, 1, 1 },

  { 9, "Observer output /eta_hat output/psi_hat", 0, EXT_OUT, 1, 1, 1 },

  { 10, "Observer output /nu_hat output/u_hat", 0, EXT_OUT, 1, 1, 1 },

  { 11, "Observer output /nu_hat output/v_hat", 0, EXT_OUT, 1, 1, 1 },

  { 12, "Observer output /nu_hat output/r_hat", 0, EXT_OUT, 1, 1, 1 },

  { 13, "Observer output /nu_dot_hat output/u_dot_hat", 0, EXT_OUT, 1, 1, 1 },

  { 14, "Observer output /nu_dot_hat output/v_dot_hat", 0, EXT_OUT, 1, 1, 1 },

  { 15, "Observer output /nu_dot_hat output/r_dot_hat", 0, EXT_OUT, 1, 1, 1 },

  { 16, "Observer output /b_hat output/b_x_hat", 0, EXT_OUT, 1, 1, 1 },

  { 17, "Observer output /b_hat output/b_y_hat", 0, EXT_OUT, 1, 1, 1 },

  { 18, "Observer output /b_hat output/b_psi_hat", 0, EXT_OUT, 1, 1, 1 },

  { 19, "gain/alpha1", 1, EXT_OUT, 1, 1, 1 },

  { 20, "gain/alpha2", 1, EXT_OUT, 1, 1, 1 },

  { 21, "gain/alpha3", 1, EXT_OUT, 1, 1, 1 },

  { 22, "gain/alpha4", 1, EXT_OUT, 1, 1, 1 },

  { 23, "gain/alpha5", 1, EXT_OUT, 1, 1, 1 },

  { 24, "gain/alpha6", 1, EXT_OUT, 1, 1, 1 },

  { 25, "gain/u1", 0, EXT_OUT, 1, 1, 1 },

  { 26, "gain/u2", 0, EXT_OUT, 1, 1, 1 },

  { 27, "gain/u3", 0, EXT_OUT, 1, 1, 1 },

  { 28, "gain/u4", 0, EXT_OUT, 1, 1, 1 },

  { 29, "gain/u5", 0, EXT_OUT, 1, 1, 1 },

  { 30, "gain/u6", 0, EXT_OUT, 1, 1, 1 },

  { 31, "y_hat", 0, EXT_OUT, 1, 1, 1 },

  { 32, "PID controller1/y_error", 0, EXT_OUT, 1, 1, 1 },

  { 33, "PID controller1/psi_error", 0, EXT_OUT, 1, 1, 1 },

  { 34, "PID controller1/x_error", 0, EXT_OUT, 1, 1, 1 },

  { 35, "Thruster control /Thruster 1/Propeller Hydrodynamics/Control_test_Pa",
    0, EXT_OUT, 1, 1, 1 },
...
static const char* NI_CompiledModelDateTime = "Tue Jul 18 10:57:11 2017";
  ...
  * clockTicksNames, int32_t* clockTicks)
{
  ...
  if ((discStates != NULL) && (discStatesNames != NULL)) {
    ...
    for (count = 0; count < 6; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK1,
        count, 25, 0);
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK1_n, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK1_n");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK1_p, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK1_p");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.y_hat_DWORK1_m, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.y_hat_DWORK1_m");
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK1_b, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK1_b");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK1_ls, 0,
      0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK1_ls");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK1_dy0,
      0, 0, 0);
    strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK1_dy0");
    discStates[idx] = NIRT_GetValueByDataType
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.Inputtomodel_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.OutputtoWorkspace_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.thr_angle_1_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.thr_angle_2_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.thr_angle_3_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.thr_angle_4_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.thr_angle_5_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.thr_angle_6_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.Angle_controller_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK2_a,
        count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK2_a");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK2_o,
        count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK2_o");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK2_ie,
        count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK2_ie");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.y_hat_DWORK2_a,
        count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.y_hat_DWORK2_a");
    }
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK2_my,
        count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK2_my");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType
        (&ctrl_custom_DW.Control_test_Pa_DWORK2, count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100),
    ...
    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK2_mn,
        count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK2_mn");
    }

    for (count = 0; count < 12; count++) {
      discStates[idx] = NIRT_GetValueByDataType(&ctrl_custom_DW.reset_DWORK2_i4,
        count, 23, 0);
      strcpy(discStatesNames + (idx++ * 100), "&ctrl_custom_DW.reset_DWORK2_i4");
    }
  ...
  int32_t* clockTicks)
{
  ...
  if (discStates != NULL) {
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.thr_angle_6_DWORK1, 0,
      discStates[idx++], 0, 0);
    for (count = 0; count < 6; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1, count,
        discStates[idx++], 25, 0);
    }
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1_f, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1_n, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1_d, 0, discStates[idx++],
      0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1_p, 0, discStates[idx++],
      0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.u6_DWORK1, 0, discStates[idx++], 0,
      0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.y_hat_DWORK1_m, 0, discStates[idx++],
      0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.Memory_PreviousInput, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1_b, 0, discStates[idx++],
      0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.Memory_PreviousInput_d, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1_ls, 0, discStates[idx++],
      0, 0);
    ...
    NIRT_SetValueByDataType(&ctrl_custom_DW.Memory_PreviousInput_f2, 0,
      discStates[idx++], 0, 0);
    NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK1_dy0, 0, discStates[idx
      ++], 0, 0);
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK2_a, count,
        discStates[idx++], 23, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK2_o, count,
        discStates[idx++], 23, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK2_ie, count,
        discStates[idx++], 23, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.y_hat_DWORK2_a, count,
        discStates[idx++], 23, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK2_my, count,
        discStates[idx++], 23, 0);
    }
    ...
    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK2_mn, count,
        discStates[idx++], 23, 0);
    }

    for (count = 0; count < 12; count++) {
      NIRT_SetValueByDataType(&ctrl_custom_DW.reset_DWORK2_i4, count,
        discStates[idx++], 23, 0);
    }
